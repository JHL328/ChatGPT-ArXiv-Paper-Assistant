...
Total arXiv papers: 528

Total scanned papers: 294

Total relevant papers: 1

**Table of contents with paper titles:**

1. [GeoPT: Scaling Physics Simulation via Lifted Geometric Pre-Training](#user-content-link1)
**Authors:** Haixu Wu, Minghao Guo, Zongyi Li, Zhiyang Dou, Mingsheng Long, Kaiming He, Wojciech Matusik

---

## 1. [GeoPT: Scaling Physics Simulation via Lifted Geometric Pre-Training](https://arxiv.org/abs/2602.20399) <a id="link1"></a>
