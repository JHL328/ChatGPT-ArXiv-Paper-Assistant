...
1. [Fairy2i: Training Complex LLMs from Real LLMs with All Parameters in $\{\pm 1, \pm i\}$](#user-content-link1)
...
4. [Think Before You Prune: Self-Reflective Structured Pruning for Reasoning Language Models](#user-content-link4)
**Authors:** Ziyan Wang, Enmao Diao, Qi Le, Pu Wang, Guanchu Wang, Minwoo Lee, Shu-ping Yeh, Li Yang

5. [Understanding and Harnessing Sparsity in Unified Multimodal Models](#user-content-link5)
**Authors:** Shwai He, Chaorui Deng, Ang Li, Shen Yan

6. [Globally optimized SVD compression of LLMs via Fermi-function-based rank selection and gauge fixing](#user-content-link6)
**Authors:** Roman Rausch, David Jansen, Sukhbinder Singh, Rom\'an Or\'us

7. [Convergence for Discrete Parameter Updates](#user-content-link7)
**Authors:** Paul Wilson, Fabio Zanasi, George Constantinides

8. [PSA: Pyramid Sparse Attention for Efficient Video Understanding and Generation](#user-content-link8)
**Authors:** Xiaolong Li, Youping Gu, Xi Lin, Weijie Wang, Bohan Zhuang

9. [When does Gaussian equivalence fail and how to fix it: Non-universal behavior of random features with quadratic scaling](#user-content-link9)
**Authors:** Garrett G. Wen, Hong Hu, Yue M. Lu, Zhou Fan, Theodor Misiakiewicz

10. [Diagonalizing the Softmax: Hadamard Initialization for Tractable Cross-Entropy Dynamics](#user-content-link10)
**Authors:** Connall Garrod, Jonathan P. Keating, Christos Thrampoulidis

11. [CUDA-L2: Surpassing cuBLAS Performance for Matrix Multiplication through Reinforcement Learning](#user-content-link11)
**Authors:** Songqiao Su, Xiaofei Sun, Xiaoya Li, Albert Wang, Jiwei Li, Chris Shum

12. [Enforcing Orderedness to Improve Feature Consistency](#user-content-link12)
**Authors:** Sophie L. Wang, Alex Quach, Nithin Parsan, John J. Yang

13. [Dynamical Properties of Tokens in Self-Attention and Effects of Positional Encoding](#user-content-link13)
**Authors:** Duy-Tung Pham, An The Nguyen, Viet-Hoang Tran, Nhan-Phu Chung, Xin T. Tong, Tan M. Nguyen, Thieu N. Vo

14. [Data Curation Through the Lens of Spectral Dynamics: Static Limits, Dynamic Acceleration, and Practical Oracles](#user-content-link14)
**Authors:** Yizhou Zhang, Lun Du

15. [Grokked Models are Better Unlearners](#user-content-link15)
**Authors:** Yuanbang Liang, Yang Li

16. [Model Recovery at the Edge under Resource Constraints for Physical AI](#user-content-link16)
**Authors:** Bin Xu, Ayan Banerjee, Sandeep K. S. Gupta

17. [Too Late to Recall: Explaining the Two-Hop Problem in Multimodal Knowledge Retrieval](#user-content-link17)
**Authors:** Constantin Venhoff, Ashkan Khakzar, Sonia Joseph, Philip Torr, Neel Nanda

18. [Tuning-Free Structured Sparse Recovery of Multiple Measurement Vectors using Implicit Regularization](#user-content-link18)
**Authors:** Lakshmi Jayalal, Sheetal Kalyani

19. [A Preliminary Study on the Promises and Challenges of Native Top-$k$ Sparse Attention](#user-content-link19)
**Authors:** Di Xiu, Hongyin Tang, Bolin Rong, Lizhi Yan, Jingang Wang, Yifan Lu, Xunliang Cai

20. [UniQL: Unified Quantization and Low-rank Compression for Adaptive Edge LLMs](#user-content-link20)
**Authors:** Hung-Yueh Chiang, Chi-Chih Chang, Yu-Chen Lu, Chien-Yu Lin, Kai-Chiang Wu, Mohamed S. Abdelfattah, Diana Marculescu

21. [TokenPowerBench: Benchmarking the Power Consumption of LLM Inference](#user-content-link21)
**Authors:** Chenxu Niu, Wei Zhang, Jie Li, Yongjian Zhao, Tongyang Wang, Xi Wang, Yong Chen

22. [Universally Converging Representations of Matter Across Scientific Foundation Models](#user-content-link22)
**Authors:** Sathya Edamadaka, Soojung Yang, Ju Li, Rafael G\'omez-Bombarelli

23. [In-Context Representation Hijacking](#user-content-link23)
**Authors:** Itay Yona, Amir Sarid, Michael Karasik, Yossi Gandelsman

24. [Domain Feature Collapse: Implications for Out-of-Distribution Detection and Solutions](#user-content-link24)
**Authors:** Hong Yang, Devroop Kar, Qi Yu, Alex Ororbia, Travis Desell

25. [Efficient Public Verification of Private ML via Regularization](#user-content-link25)
**Authors:** Zo\"e Ruha Bell, Anvith Thudi, Olive Franzese-McLaughlin, Nicolas Papernot, Shafi Goldwasser

26. [Exploring Depth Generalization in Large Language Models for Solving Recursive Logic Tasks](#user-content-link26)
**Authors:** Zhiyuan He

27. [From monoliths to modules: Decomposing transducers for efficient world modelling](#user-content-link27)
**Authors:** Alexander Boyd, Franz Nowak, David Hyland, Manuel Baltieri, Fernando E. Rosas

28. [Density-Informed VAE (DiVAE): Reliable Log-Prior Probability via Density Alignment Regularization](#user-content-link28)
**Authors:** Michele Alessi, Alessio Ansuini, Alex Rodriguez

29. [Ada-MoGE: Adaptive Mixture of Gaussian Expert Model for Time Series Forecasting](#user-content-link29)
**Authors:** Zhenliang Ni, Xiaowen Ma, Zhenkai Wu, Shuai Xiao, Han Shu, Xinghao Chen

30. [Mitigating Intra- and Inter-modal Forgetting in Continual Learning of Unified Multimodal Models](#user-content-link30)
**Authors:** Xiwen Wei, Mustafa Munir, Radu Marculescu

31. [Optical Context Compression Is Just (Bad) Autoencoding](#user-content-link31)
**Authors:** Ivan Yee Lee, Cheng Yang, Taylor Berg-Kirkpatrick

---

## 1. [Fairy2i: Training Complex LLMs from Real LLMs with All Parameters in $\{\pm 1, \pm i\}$](https://arxiv.org/abs/2512.02901) <a id="link1"></a>
...
**Comment:** Strongly matches Model Compression/Efficiency: extreme low-bit quantization via real-to-widely-linear complex conversion and multiplication-free accumulation; architectural equivalence proof.
...
**Comment:** Matches Model Architecture (reversible LLMs) and ML Systems/HPC (memory optimization via activation-free backpropagation enabling larger batches).
...
**Comment:** Model compression/efficiency: learned KV-cache token retention gates with capacity-aware training for memory-bounded LLM inference; algorithm–system co-design for cache management.
...
## 4. [Think Before You Prune: Self-Reflective Structured Pruning for Reasoning Language Models](https://arxiv.org/abs/2512.02185) <a id="link4"></a>
...
**Comment:** Model compression: self-reflective structured pruning for reasoning LLMs using self-generated CoT traces, decode-only gradient importance, and progressive regeneration.
...
## 5. [Understanding and Harnessing Sparsity in Unified Multimodal Models](https://arxiv.org/abs/2512.02351) <a id="link5"></a>
...
**Comment:** Model Architecture & Efficiency — analyzes sparsity in unified multimodal models and introduces MoE adaptation with sparse activation to retain generation quality at lower activation cost.
...
## 6. [Globally optimized SVD compression of LLMs via Fermi-function-based rank selection and gauge fixing](https://arxiv.org/abs/2512.03062) <a id="link6"></a>
...
**Comment:** Model Compression and Efficiency: low-rank SVD compression of LLMs with globally optimized layer-wise rank selection via Fermi-function relaxation and lossless gauge-fixing of factors.
...
## 7. [Convergence for Discrete Parameter Updates](https://arxiv.org/abs/2512.04051) <a id="link7"></a>
...
**Comment:** Model Compression and Efficiency: proposes discrete update rules for low-precision training with convergence guarantees, avoiding quantized continuous updates.
...
## 8. [PSA: Pyramid Sparse Attention for Efficient Video Understanding and Generation](https://arxiv.org/abs/2512.04025) <a id="link8"></a>
...
**Comment:** Model Architecture + Efficiency + Systems: pyramid sparse attention with multi-level pooled KV and a hardware-friendly kernel (block–tile design) for efficient video models.
...
## 9. [When does Gaussian equivalence fail and how to fix it: Non-universal behavior of random features with quadratic scaling](https://arxiv.org/abs/2512.03325) <a id="link9"></a>
...
**Comment:** Matches Representation Learning and training dynamics theory: identifies failures of Gaussian Equivalence and proposes a Conditional Gaussian Equivalent model with sharp asymptotics for RF-ERM under quadratic scaling.
...
## 10. [Diagonalizing the Softmax: Hadamard Initialization for Tractable Cross-Entropy Dynamics](https://arxiv.org/abs/2512.04006) <a id="link10"></a>
...
**Comment:** Matches Representation Learning/training dynamics: analyzes multi-class cross-entropy dynamics in a non-convex two-layer model, proves convergence to neural collapse, and introduces Hadamard initialization that diagonalizes the softmax operator.
...
## 11. [CUDA-L2: Surpassing cuBLAS Performance for Matrix Multiplication through Reinforcement Learning](https://arxiv.org/abs/2512.02551) <a id="link11"></a>
...
**Comment:** Matches ML Systems/HPC: LLM+RL-driven CUDA kernel generation/autotuning for HGEMM with kernel-level optimization and strong, reproducible speedups surpassing cuBLAS.
...
## 12. [Enforcing Orderedness to Improve Feature Consistency](https://arxiv.org/abs/2512.02194) <a id="link12"></a>
...
**Comment:** Representation Learning + Sparsity — Ordered Sparse Autoencoders resolve permutation non-identifiability with theoretical guarantees and improve feature consistency.
...
## 13. [Dynamical Properties of Tokens in Self-Attention and Effects of Positional Encoding](https://arxiv.org/abs/2512.03058) <a id="link13"></a>
...
**Comment:** Model Architecture & Training Dynamics — continuous-time analysis of self-attention token dynamics and positional encodings; proposes architecture refinements based on theory.
...
## 14. [Data Curation Through the Lens of Spectral Dynamics: Static Limits, Dynamic Acceleration, and Practical Oracles](https://arxiv.org/abs/2512.02409) <a id="link14"></a>
...
**Comment:** Representation Learning / training dynamics: spectral-operator analysis of data curation showing static pruning cannot change the spectral tail exponent and motivating time-dependent reweighting for accelerated learning; foundational, general insights.
...
## 15. [Grokked Models are Better Unlearners](https://arxiv.org/abs/2512.03437) <a id="link15"></a>
...
**Comment:** Representation Learning / Training Dynamics: links grokking to improved machine unlearning with analyses of feature modularity and gradient alignment
...
## 16. [Model Recovery at the Edge under Resource Constraints for Physical AI](https://arxiv.org/abs/2512.02283) <a id="link16"></a>
...
**Comment:** ML-Systems + Model Architecture: algorithm–system co-design replacing iterative NODE solvers with a parallelizable architecture on FPGA with memory/energy analysis
...
## 17. [Too Late to Recall: Explaining the Two-Hop Problem in Multimodal Knowledge Retrieval](https://arxiv.org/abs/2512.03276) <a id="link17"></a>
...
**Comment:** Matches Representation Learning: mechanistic analysis of VLM factual recall circuits via activation/attribution patching and probing, explaining two-hop failures.
...
## 18. [Tuning-Free Structured Sparse Recovery of Multiple Measurement Vectors using Implicit Regularization](https://arxiv.org/abs/2512.03393) <a id="link18"></a>
...
**Comment:** Matches Compression/Efficiency (Sparsity): tuning-free jointly sparse recovery via implicit regularization with theoretical analysis of gradient dynamics promoting row-sparsity.
...
## 19. [A Preliminary Study on the Promises and Challenges of Native Top-$k$ Sparse Attention](https://arxiv.org/abs/2512.03494) <a id="link19"></a>
...
**Comment:** Compression/Efficiency: native Top-k sparse attention for training and inference, with analysis of approximation fidelity and entropy; aligns with sparsity-focused efficiency methods.
...
## 20. [UniQL: Unified Quantization and Low-rank Compression for Adaptive Edge LLMs](https://arxiv.org/abs/2512.03383) <a id="link20"></a>
...
**Comment:** Matches Model Compression and Efficiency: unified post-training quantization + low-rank compression with quantization-aware SVD, structured weight sorting, and fused RoPE kernel; also aligns with ML Systems via on-device configurable pruning and kernel-level optimizations.
...
## 21. [TokenPowerBench: Benchmarking the Power Consumption of LLM Inference](https://arxiv.org/abs/2512.03024) <a id="link21"></a>
...
**Comment:** ML-Systems: reproducible benchmark and measurement methodology for LLM inference power with phase-aligned prefill/decode energy attribution
...
## 22. [Universally Converging Representations of Matter Across Scientific Foundation Models](https://arxiv.org/abs/2512.03750) <a id="link22"></a>
...
**Comment:** Matches Representation Learning: systematic, cross-modality analysis of representational alignment across scientific foundation models with generalizable insights into latent-space convergence and failure modes.
...
## 23. [In-Context Representation Hijacking](https://arxiv.org/abs/2512.03771) <a id="link23"></a>
...
**Comment:** Matches Representation Learning/Training Dynamics: demonstrates in-context representation hijacking that rewires latent semantics, revealing alignment limits at the representation level.
...
## 24. [Domain Feature Collapse: Implications for Out-of-Distribution Detection and Solutions](https://arxiv.org/abs/2512.04034) <a id="link24"></a>
...
**Comment:** Representation Learning — information-theoretic analysis of domain feature collapse (IB/Fano), explaining OOD failure and guiding when to preserve domain information.
...
## 25. [Efficient Public Verification of Private ML via Regularization](https://arxiv.org/abs/2512.04008) <a id="link25"></a>
...
**Comment:** ML-Systems / Training Algorithms: DP-SCO method with near-optimal trade-offs and verification cheaper than training (theoretical composition-based guarantees)
...
## 26. [Exploring Depth Generalization in Large Language Models for Solving Recursive Logic Tasks](https://arxiv.org/abs/2512.02677) <a id="link26"></a>
...
**Comment:** Representation Learning and Model Architecture: analyzes depth generalization limits in Transformers (stack-like behavior) and introduces a locate-and-replace pipeline to handle recursion depth.
...
## 27. [From monoliths to modules: Decomposing transducers for efficient world modelling](https://arxiv.org/abs/2512.02193) <a id="link27"></a>
...
**Comment:** Matches Model Architecture/ML Systems: formal decomposition of transducers into sub-transducers enabling parallelizable, interpretable world models and distributed inference.
...
## 28. [Density-Informed VAE (DiVAE): Reliable Log-Prior Probability via Density Alignment Regularization](https://arxiv.org/abs/2512.03928) <a id="link28"></a>
...
**Comment:** Representation Learning and Model Architecture (VAE): introduces a density-alignment regularizer that shapes the latent prior toward data-density via a modified ELBO penalty, improving interpretability and OOD behavior.
...
## 29. [Ada-MoGE: Adaptive Mixture of Gaussian Expert Model for Time Series Forecasting](https://arxiv.org/abs/2512.02061) <a id="link29"></a>
...
**Comment:** Model Architecture: adaptive Mixture-of-Experts that selects the number of Gaussian experts based on spectral cues, a conditional/dynamic network design aimed at balancing coverage vs. noise.
...
## 30. [Mitigating Intra- and Inter-modal Forgetting in Continual Learning of Unified Multimodal Models](https://arxiv.org/abs/2512.03125) <a id="link30"></a>
...
**Comment:** Model Architecture: modality-decoupled experts to mitigate gradient conflict and catastrophic forgetting in unified multimodal generative models; aligns with MoE-style design and continual learning dynamics.
...
## 31. [Optical Context Compression Is Just (Bad) Autoencoding](https://arxiv.org/abs/2512.03643) <a id="link31"></a>
...
**Comment:** Model Compression and Efficiency: critical analysis of context compression strategies for LLMs, showing simple autoencoding baselines outperform vision-based compression for LM utility.
