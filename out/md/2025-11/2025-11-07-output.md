...
1. [The Strong Lottery Ticket Hypothesis for Multi-Head Attention Mechanisms](#user-content-link1)
**Authors:** Hikari Otsuka, Daiki Chijiwa, Yasuyuki Okoshi, Daichi Fujiki, Susumu Takeuchi, Masato Motomura

2. [SnapStream: Efficient Long Sequence Decoding on Dataflow Accelerators](#user-content-link2)
...
4. [TwIST: Rigging the Lottery in Transformers with Independent Subnetwork Training](#user-content-link4)
...
6. [LogHD: Robust Compression of Hyperdimensional Classifiers via Logarithmic Class-Axis Reduction](#user-content-link6)
**Authors:** Sanggeon Yun, Hyunwoo Oh, Ryozo Masukawa, Pietro Mercati, Nathaniel D. Bastian, Mohsen Imani

7. [An Augmentation Overlap Theory of Contrastive Learning](#user-content-link7)
**Authors:** Qi Zhang, Yifei Wang, Yisen Wang

8. [PerfDojo: Automated ML Library Generation for Heterogeneous Architectures](#user-content-link8)
...
9. [Memory- and Latency-Constrained Inference of Large Language Models via Adaptive Split Computing](#user-content-link9)
**Authors:** Mingyu Sung, Vikas Palakonda, Suhwan Im, Sunghwan Moon, Il-Min Kim, Sangseok Yun, Jae-Mo Kang

10. [ODE approximation for the Adam algorithm: General and overparametrized setting](#user-content-link10)
**Authors:** Steffen Dereich, Arnulf Jentzen, Sebastian Kassing

11. [Distribution-Aware Tensor Decomposition for Compression of Convolutional Neural Networks](#user-content-link11)
**Authors:** Alper Kalle, Theo Rudkiewicz, Mohamed-Oumar Ouerfelli, Mohamed Tamaazousti

12. [Efficient Linear Attention for Multivariate Time Series Modeling via Entropy Equality](#user-content-link12)
**Authors:** Mingtao Zhang, Guoli Yang, Zhanxing Zhu, Mengzhu Wang, Xiaoying Bai

13. [AILA--First Experiments with Localist Language Models](#user-content-link13)
**Authors:** Joachim Diederich

14. [GMoPE:A Prompt-Expert Mixture Framework for Graph Foundation Models](#user-content-link14)
**Authors:** Zhibin Wang, Zhixing Zhang, Shuqi Wang, Xuanting Xie, Zhao Kang

15. [DecoHD: Decomposed Hyperdimensional Classification under Extreme Memory Budgets](#user-content-link15)
**Authors:** Sanggeon Yun, Hyunwoo Oh, Ryozo Masukawa, Mohsen Imani

16. [Forgetting is Everywhere](#user-content-link16)
**Authors:** Ben Sanati, Thomas L. Lee, Trevor McInroe, Aidan Scannell, Nikolay Malkin, David Abel, Amos Storkey

17. [A general technique for approximating high-dimensional empirical kernel matrices](#user-content-link17)
**Authors:** Chiraag Kaushik, Justin Romberg, Vidya Muthukumar

18. [Robustness of Minimum-Volume Nonnegative Matrix Factorization under an Expanded Sufficiently Scattered Condition](#user-content-link18)
**Authors:** Giovanni Barbarino, Nicolas Gillis, Subhayan Saha

19. [On the Equivalence of Regression and Classification](#user-content-link19)
**Authors:** Jayadeva, Naman Dwivedi, Hari Krishnan, N. M. Anoop Krishnan

20. [Integrating Temporal and Structural Context in Graph Transformers for Relational Deep Learning](#user-content-link20)
**Authors:** Divyansha Lachi, Mahmoud Mohammadi, Joe Meyer, Vinam Arora, Tom Palczewski, Eva L. Dyer

21. [GRAD: Graph-Retrieved Adaptive Decoding for Hallucination Mitigation](#user-content-link21)
**Authors:** Manh Nguyen, Sunil Gupta, Dai Do, Hung Le

22. [High-dimensional limit theorems for SGD: Momentum and Adaptive Step-sizes](#user-content-link22)
**Authors:** Aukosh Jagannath, Taj Jones-McCormick, Varnan Sarangian

23. [Spurious Correlation-Aware Embedding Regularization for Worst-Group Robustness](#user-content-link23)
**Authors:** Subeen Park, Joowang Kim, Hakyung Lee, Sunjae Yoo, Kyungwoo Song

24. [REMIND: Input Loss Landscapes Reveal Residual Memorization in Post-Unlearning LLMs](#user-content-link24)
**Authors:** Liran Cohen, Yaniv Nemcovesky, Avi Mendelson

---

## 1. [The Strong Lottery Ticket Hypothesis for Multi-Head Attention Mechanisms](https://arxiv.org/abs/2511.04217) <a id="link1"></a>
...
**Comment:** Model Architecture theory: proves Strong Lottery Ticket existence for Multi-Head Attention and extends SLTH to Transformer blocks.
...
## 2. [SnapStream: Efficient Long Sequence Decoding on Dataflow Accelerators](https://arxiv.org/abs/2511.03092) <a id="link2"></a>
...
**Comment:** ML Systems/HPC — deployable KV-cache compression for long-context inference compatible with static graphs and continuous batching; first production deployment of sparse KV attention on dataflow accelerators.
...
**Comment:** Model Compression and Efficiency (PTQ under MXFP4 FP4); identifies rotation incompatibility with PoT block scaling and proposes block rotation—strong systems-aware quantization insight.
...
## 4. [TwIST: Rigging the Lottery in Transformers with Independent Subnetwork Training](https://arxiv.org/abs/2511.03983) <a id="link4"></a>
...
**Comment:** Model Compression and Efficiency + ML Systems (distributed independent subnetwork training with periodic aggregation for structured sparsification and zero-cost pruning).
...
**Comment:** Matches Model Compression and Efficiency: proposes a distribution-aware rotational calibration and QR-Orth optimization for LLM quantization with large speed/memory gains.
...
## 6. [LogHD: Robust Compression of Hyperdimensional Classifiers via Logarithmic Class-Axis Reduction](https://arxiv.org/abs/2511.03938) <a id="link6"></a>
...
**Comment:** Model Compression and Efficiency — logarithmic class-axis reduction for HDC with capacity-aware codebook and robust decoding; strong ASIC evidence for energy/speed gains.
...
## 7. [An Augmentation Overlap Theory of Contrastive Learning](https://arxiv.org/abs/2511.03114) <a id="link7"></a>
...
**Comment:** Matches Representation Learning: provides a theoretical analysis of contrastive learning via an augmentation-overlap framework with tight bounds and an unsupervised representation-quality metric.
...
## 8. [PerfDojo: Automated ML Library Generation for Heterogeneous Architectures](https://arxiv.org/abs/2511.03586) <a id="link8"></a>
...
**Comment:** ML Systems/Compiler: automatic kernel/library generation via human-readable IR and LLM+RL optimization across heterogeneous CPUs/GPUs (operator/codegen design).
...
## 9. [Memory- and Latency-Constrained Inference of Large Language Models via Adaptive Split Computing](https://arxiv.org/abs/2511.04002) <a id="link9"></a>
...
**Comment:** ML Systems + Compression/Efficiency: autoregressive-aware split computing with mixed-precision OPSC, activation compression (TS+TAB-Q), and joint optimization under memory/latency constraints.
...
## 10. [ODE approximation for the Adam algorithm: General and overparametrized setting](https://arxiv.org/abs/2511.04622) <a id="link10"></a>
...
**Comment:** Matches Representation Learning criterion: ODE-based analysis of Adam optimizer dynamics (fast–slow scaling) with convergence/limit characterizations in overparameterized regimes.
...
## 11. [Distribution-Aware Tensor Decomposition for Compression of Convolutional Neural Networks](https://arxiv.org/abs/2511.04494) <a id="link11"></a>
...
**Comment:** Model Compression/Efficiency: distribution-aware low-rank tensor decompositions (Tucker-2/CPD) with ALS optimizing a covariance-weighted norm; often removes need for fine-tuning.
...
## 12. [Efficient Linear Attention for Multivariate Time Series Modeling via Entropy Equality](https://arxiv.org/abs/2511.03190) <a id="link12"></a>
...
**Comment:** Matches Model Architecture and Efficiency: proposes a linear-complexity attention via entropy-based approximation with theoretical analysis for long sequences.
...
## 13. [AILA--First Experiments with Localist Language Models](https://arxiv.org/abs/2511.03559) <a id="link13"></a>
...
**Comment:** Model Architecture + Representation Learning (controllable locality dial in transformers to interpolate between localist and distributed representations).
...
## 14. [GMoPE:A Prompt-Expert Mixture Framework for Graph Foundation Models](https://arxiv.org/abs/2511.03251) <a id="link14"></a>
...
**Comment:** Matches Model Architecture: Mixture-of-Experts with structure-aware routing and prompt-expert design; also efficiency via prompt-only fine-tuning.
...
## 15. [DecoHD: Decomposed Hyperdimensional Classification under Extreme Memory Budgets](https://arxiv.org/abs/2511.03911) <a id="link15"></a>
...
**Comment:** Model Compression and Efficiency — decomposed HDC parameterization with multiplicative binding and compact factors enabling extreme memory/energy savings and pure-HDC inference.
...
## 16. [Forgetting is Everywhere](https://arxiv.org/abs/2511.04666) <a id="link16"></a>
...
**Comment:** Representation Learning/Training Dynamics (theory of forgetting as predictive information loss; algorithm-agnostic measure across learning settings).
...
## 17. [A general technique for approximating high-dimensional empirical kernel matrices](https://arxiv.org/abs/2511.03892) <a id="link17"></a>
...
**Comment:** Matches Representation Learning criterion: theoretical operator-norm bounds and approximations for high-dimensional kernel matrices with implications for kernel regression.
...
## 18. [Robustness of Minimum-Volume Nonnegative Matrix Factorization under an Expanded Sufficiently Scattered Condition](https://arxiv.org/abs/2511.04291) <a id="link18"></a>
...
**Comment:** Matches Representation Learning: theoretical robustness guarantees for minimum-volume NMF (dictionary learning) under an expanded sufficiently scattered condition.
...
## 19. [On the Equivalence of Regression and Classification](https://arxiv.org/abs/2511.04422) <a id="link19"></a>
...
**Comment:** Matches Representation Learning/foundations: establishes a formal equivalence between regression and classification, introduces a regressability measure, and uses a learned linearizing map—core theoretical insight.
...
## 20. [Integrating Temporal and Structural Context in Graph Transformers for Relational Deep Learning](https://arxiv.org/abs/2511.04557) <a id="link20"></a>
...
**Comment:** Model Architecture — Relational Graph Perceiver with a cross-attention latent bottleneck and temporal subgraph sampler for scalable relational modeling.
...
## 21. [GRAD: Graph-Retrieved Adaptive Decoding for Hallucination Mitigation](https://arxiv.org/abs/2511.03900) <a id="link21"></a>
...
**Comment:** ML Systems (inference-time algorithm) — training-free decoding method that fuses model logits with corpus-derived token-transition graph to reduce hallucinations.
...
## 22. [High-dimensional limit theorems for SGD: Momentum and Adaptive Step-sizes](https://arxiv.org/abs/2511.03952) <a id="link22"></a>
...
**Comment:** Matches Representation Learning criterion: rigorous high-dimensional training dynamics analysis of SGD with momentum and adaptive step-sizes.
...
## 23. [Spurious Correlation-Aware Embedding Regularization for Worst-Group Robustness](https://arxiv.org/abs/2511.04401) <a id="link23"></a>
...
**Comment:** Matches Representation Learning: theoretical link between embedding directions (core vs. spurious) and worst-group error with an embedding-level regularizer.
...
## 24. [REMIND: Input Loss Landscapes Reveal Residual Memorization in Post-Unlearning LLMs](https://arxiv.org/abs/2511.04228) <a id="link24"></a>
...
**Comment:** Matches Representation Learning: proposes a loss-landscape based evaluation revealing residual memorization/unlearning dynamics in LLMs, offering insights into how models encode and forget information.
