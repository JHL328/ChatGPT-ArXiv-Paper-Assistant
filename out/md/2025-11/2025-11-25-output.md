...
2. [Equivalence of Context and Parameter Updates in Modern Transformer Blocks](#user-content-link2)
**Authors:** Adrian Goldwaser, Michael Munn, Javier Gonzalvo, Benoit Dherin

3. [Layer-Wise High-Impact Parameter Ratio Optimization in Post-Training Quantization for Large Language Models](#user-content-link3)
**Authors:** Cuong Pham, Hoang Anh Dung, Cuong C. Nguyen, Trung Le, Gustavo Carneiro, Thanh-Toan Do

4. [AdaPerceiver: Transformers with Adaptive Width, Depth, and Tokens](#user-content-link4)
**Authors:** Purvish Jajal, Nick John Eliopoulos, Benjamin Shiue-Hal Chou, George K. Thiruvathukal, Yung-Hsiang Lu, James C. Davis

5. [$A^3$: Attention-Aware Accurate KV Cache Fusion for Fast Large Language Model Serving](#user-content-link5)
**Authors:** Yuechi Zhou, Yi Su, Jianxin Zhang, Juntao Li, Qingrong Xia, Zhefeng Wang, Xinyu Duan, Baoxing Huai

6. [FastMMoE: Accelerating Multimodal Large Language Models through Dynamic Expert Activation and Routing-Aware Token Pruning](#user-content-link6)
**Authors:** Guoyang Xia, Yifeng Ding, Fengfa Li, Lei Ren, Wei Chen, Fangxiang Feng, Xiaojie Wang

7. [SWAN: Sparse Winnowed Attention for Reduced Inference Memory via Decompression-Free KV-Cache Compression](#user-content-link7)
**Authors:** Santhosh G S, Saurav Prakash, Balaraman Ravindran

8. [AnyExperts: On-Demand Expert Allocation for Multimodal Language Models with Mixture of Expert](#user-content-link8)
**Authors:** Yuting Gao, Wang Lan, Hengyuan Zhao, Linjiang Huang, Si Liu, Qingpei Guo

9. [Adaptive Layer-Wise Transformations for Post-Training Quantization of Large Language Models](#user-content-link9)
**Authors:** Cuong Pham, Hoang Anh Dung, Cuong C. Nguyen, Trung Le, Gustavo Carneiro, Jianfei Cai, Thanh-Toan Do

10. [Flow Map Distillation Without Data](#user-content-link10)
**Authors:** Shangyuan Tong, Nanye Ma, Saining Xie, Tommi Jaakkola

11. [PocketLLM: Ultimate Compression of Large Language Models via Meta Networks](#user-content-link11)
**Authors:** Ye Tian, Chengcheng Wang, Jing Han, Yehui Tang, Kai Han

12. [AutoSAGE: Input-Aware CUDA Scheduling for Sparse GNN Aggregation (SpMM/SDDMM) and CSR Attention](#user-content-link12)
...
14. [SAOT: An Enhanced Locality-Aware Spectral Transformer for Solving PDEs](#user-content-link14)
**Authors:** Chenhong Zhou, Jie Chen, Zaifeng Yang

15. [Internalizing Tools as Morphisms in Graded Transformers](#user-content-link15)
**Authors:** Tony Shaska

16. [Gate-level boolean evolutionary geometric attention neural networks](#user-content-link16)
**Authors:** Xianshuai Shi, Jianfeng Zhu, Leibo Liu

17. [Categorical Equivariant Deep Learning: Category-Equivariant Neural Networks and Universal Approximation Theorems](#user-content-link17)
**Authors:** Yoshihiro Maruyama

18. [Deterministic Inference across Tensor Parallel Sizes That Eliminates Training-Inference Mismatch](#user-content-link18)
**Authors:** Ziyang Zhang, Xinheng Ding, Jiayi Yuan, Rixin Liu, Huizi Mao, Jiarong Xing, Zirui Liu

19. [CDLM: Consistency Diffusion Language Models For Faster Sampling](#user-content-link19)
**Authors:** Minseo Kim, Chenfeng Xu, Coleman Hooper, Harman Singh, Ben Athiwaratkun, Ce Zhang, Kurt Keutzer, Amir Gholami

20. [Masked Diffusion Models are Secretly Learned-Order Autoregressive Models](#user-content-link20)
**Authors:** Prateek Garg, Bhavya Kohli, Sunita Sarawagi

21. [Nemotron-Flash: Towards Latency-Optimal Hybrid Small Language Models](#user-content-link21)
...
22. [From Tables to Signals: Revealing Spectral Adaptivity in TabPFN](#user-content-link22)
**Authors:** Jianqiao Zheng, Cameron Gordon, Yiping Ji, Hemanth Saratchandran, Simon Lucey

23. [OrdMoE: Preference Alignment via Hierarchical Expert Group Ranking in Multimodal Mixture-of-Experts LLMs](#user-content-link23)
**Authors:** Yuting Gao, Weihao Chen, Lan Wang, Ruihan Xu, Qingpei Guo

24. [GateRA: Token-Aware Modulation for Parameter-Efficient Fine-Tuning](#user-content-link24)
**Authors:** Jie Ou, Shuaihong Jiang, Yingjun Du, Cees G. M. Snoek

25. [Deterministic Continuous Replacement: Fast and Stable Module Replacement in Pretrained Transformers](#user-content-link25)
**Authors:** Rowan Bradbury, Aniket Srinivasan Ashok, Sai Ram Kasanagottu, Gunmay Jhingran, Shuai Meng

26. [VLM in a flash: I/O-Efficient Sparsification of Vision-Language Model via Neuron Chunking](#user-content-link26)
**Authors:** Kichang Yang, Seonjun Kim, Minjae Kim, Nairan Zhang, Chi Zhang, Youngki Lee

27. [Understanding Counting Mechanisms in Large Language and Vision-Language Models](#user-content-link27)
...
28. [FastForward Pruning: Efficient LLM Pruning via Single-Step Reinforcement Learning](#user-content-link28)
**Authors:** Xin Yuan, Siqi Li, Jiateng Wei, Chengrui Zhu, Yanming Wu, Qingpeng Li, Jiajun Lv, Xiaoke Lan, Jun Chen, Yong Liu

29. [Controllability Analysis of State Space-based Language Model](#user-content-link29)
**Authors:** Mohamed Mabrok, Yalda Zafari

30. [Using MLIR Transform to Design Sliced Convolution Algorithm](#user-content-link30)
**Authors:** Victor Ferrari, Marcio Pereira, Lucas Alvarenga, Gustavo Leite, Guido Araujo

31. [Understanding the Staged Dynamics of Transformers in Learning Latent Structure](#user-content-link31)
**Authors:** Rohan Saha, Farzane Aminmansour, Alona Fyshe

32. [Doubly Wild Refitting: Model-Free Evaluation of High Dimensional Black-Box Predictions under Convex Losses](#user-content-link32)
**Authors:** Haichen Hu, David Simchi-Levi

33. [Understanding Private Learning From Feature Perspective](#user-content-link33)
**Authors:** Meng Ding, Mingxi Lei, Shaopeng Fu, Shaowei Wang, Di Wang, Jinhui Xu

34. [Resolving Node Identifiability in Graph Neural Processes via Laplacian Spectral Encodings](#user-content-link34)
**Authors:** Zimo Yan, Zheng Xie, Chang Liu, Yuan Wang

35. [Fast Escape, Slow Convergence: Learning Dynamics of Phase Retrieval under Power-Law Data](#user-content-link35)
**Authors:** Guillaume Braun, Bruno Loureiro, Ha Quang Minh, Masaaki Imaizumi

36. [Information Physics of Intelligence: Unifying Logical Depth and Entropy under Thermodynamic Constraints](#user-content-link36)
**Authors:** Jianfeng Xu, Zeyan Li

37. [Escaping Optimization Stagnation: Taking Steps Beyond Task Arithmetic via Difference Vectors](#user-content-link37)
**Authors:** Jinping Wang, Zhiqiang Gao, Dinggen Zhang, Zhiwu Xie

38. [Weighted Birkhoff Averages Accelerate Data-Driven Methods](#user-content-link38)
**Authors:** Maria Bou-Sakr-El-Tayar, Jason J. Bramburger, Matthew J. Colbrook

39. [Equivariant Deep Equilibrium Models for Imaging Inverse Problems](#user-content-link39)
**Authors:** Alexander Mehta, Ruangrawee Kitichotkul, Vivek K Goyal, Juli\'an Tachella

40. [How Learning Rate Decay Wastes Your Best Data in Curriculum-Based LLM Pretraining](#user-content-link40)
**Authors:** Kairong Luo, Zhenbo Sun, Haodong Wen, Xinyu Shi, Jiarui Cui, Chenyi Dang, Kaifeng Lyu, Wenguang Chen

41. [Curvature-Aware Safety Restoration In LLMs Fine-Tuning](#user-content-link41)
**Authors:** Thong Bach, Thanh Nguyen-Tang, Dung Nguyen, Thao Minh Le, Truyen Tran

42. [Transforming Conditional Density Estimation Into a Single Nonparametric Regression Task](#user-content-link42)
**Authors:** Alexander G. Reisach, Olivier Collier, Alex Luedtke, Antoine Chambaz

43. [Plan-X: Instruct Video Generation via Semantic Planning](#user-content-link43)
...
44. [Physics-informed Neural Operator Learning for Nonlinear Grad-Shafranov Equation](#user-content-link44)
...
45. [MapFormer: Self-Supervised Learning of Cognitive Maps with Input-Dependent Positional Embeddings](#user-content-link45)
**Authors:** Victor Rambaud, Salvador Mascarenhas, Yair Lakretz

46. [Frugality in second-order optimization: floating-point approximations for Newton's method](#user-content-link46)
...
48. [Subtract the Corruption: Training-Data-Free Corrective Machine Unlearning using Task Arithmetic](#user-content-link48)
**Authors:** Mostafa Mozafari, Farooq Ahmad Wani, Maria Sofia Bucarelli, Fabrizio Silvestri

49. [Accelerating Time Series Foundation Models with Speculative Decoding](#user-content-link49)
**Authors:** Pranav Subbaraman, Fang Sun, Yue Yao, Huacong Tang, Xiao Luo, Yizhou Sun

50. [EnfoPath: Energy-Informed Analysis of Generative Trajectories in Flow Matching](#user-content-link50)
**Authors:** Ziyun Li, Ben Dai, Huancheng Hu, Henrik Bostr\"om, Soon Hoe Lim

51. [DeepCoT: Deep Continual Transformers for Real-Time Inference on Data Streams](#user-content-link51)
**Authors:** Gin\'es Carreto Pic\'on, Peng Yuan Zhou, Qi Zhang, Alexandros Iosifidis

52. [Comprehensive Design Space Exploration for Tensorized Neural Network Hardware Accelerators](#user-content-link52)
**Authors:** Jinsong Zhang, Minghe Li, Jiayi Tian, Jinming Lu, Zheng Zhang

53. [Adaptive Mesh-Quantization for Neural PDE Solvers](#user-content-link53)
**Authors:** Winfried van den Dool, Maksim Zhdanov, Yuki M. Asano, Max Welling

54. [Rectifying Soft-Label Entangled Bias in Long-Tailed Dataset Distillation](#user-content-link54)
...
**Comment:** Compression/Efficiency + ML Systems: 2-bit KV cache quantization with dynamic channel-wise precision boost and page-centric dequant kernels enabling large memory savings.
...
## 2. [Equivalence of Context and Parameter Updates in Modern Transformer Blocks](https://arxiv.org/abs/2511.17864) <a id="link2"></a>
...
**Comment:** Model architecture + representation learning theory: proves context effects as rank-1 implicit MLP patches and RMSNorm scaling across modern Transformer variants (incl. MoE).
...
## 3. [Layer-Wise High-Impact Parameter Ratio Optimization in Post-Training Quantization for Large Language Models](https://arxiv.org/abs/2511.17801) <a id="link3"></a>
...
**Comment:** Compression/Efficiency: PTQ for LLMs with quadratic optimization for layer-wise high-impact parameter ratios enabling extreme low-bit quantization.
...
## 4. [AdaPerceiver: Transformers with Adaptive Width, Depth, and Tokens](https://arxiv.org/abs/2511.18105) <a id="link4"></a>
...
**Comment:** Model Architecture + Efficiency: unified adaptive computation across width, depth, and tokens (conditional/dynamic transformer) with joint training for multi-config performance.
...
## 5. [$A^3$: Attention-Aware Accurate KV Cache Fusion for Fast Large Language Model Serving](https://arxiv.org/abs/2511.17560) <a id="link5"></a>
...
**Comment:** ML Systems + Efficiency: attention-aware KV cache fusion for LLM serving; algorithm–system co-design for cache reuse with reduced TTFT and preserved accuracy.
...
## 6. [FastMMoE: Accelerating Multimodal Large Language Models through Dynamic Expert Activation and Routing-Aware Token Pruning](https://arxiv.org/abs/2511.17885) <a id="link6"></a>
...
**Comment:** Mixture-of-Experts & Efficiency: training-free acceleration via dynamic expert activation reduction and routing-aware token pruning for MoE-MLLMs.
...
## 7. [SWAN: Sparse Winnowed Attention for Reduced Inference Memory via Decompression-Free KV-Cache Compression](https://arxiv.org/abs/2511.18936) <a id="link7"></a>
...
**Comment:** ML systems and efficiency: decompression-free KV-cache compression using orthogonal rotation and pruning; runtime-tunable memory footprint for LLM inference.
...
## 8. [AnyExperts: On-Demand Expert Allocation for Multimodal Language Models with Mixture of Expert](https://arxiv.org/abs/2511.18314) <a id="link8"></a>
...
**Comment:** Model Architecture & Efficiency: Mixture-of-Experts with on-demand, budget-aware dynamic routing (variable per-token expert slots) and virtual experts to cap activations.
...
## 9. [Adaptive Layer-Wise Transformations for Post-Training Quantization of Large Language Models](https://arxiv.org/abs/2511.17809) <a id="link9"></a>
...
**Comment:** Compression/Efficiency: adaptive per-layer transformation selection for PTQ of LLMs; links weight kurtosis to optimal transforms; strong low-bit results.
...
## 10. [Flow Map Distillation Without Data](https://arxiv.org/abs/2511.19428) <a id="link10"></a>
...
**Comment:** Model Compression and Efficiency: data-free flow map distillation to accelerate flow-model sampling, avoiding teacher–data mismatch and achieving 1-step SOTA.
...
## 11. [PocketLLM: Ultimate Compression of Large Language Models via Meta Networks](https://arxiv.org/abs/2511.17637) <a id="link11"></a>
...
**Comment:** Model Compression and Efficiency: meta-network encoder–codebook–decoder compresses LLM weights in latent space for extreme compression.
...
## 12. [AutoSAGE: Input-Aware CUDA Scheduling for Sparse GNN Aggregation (SpMM/SDDMM) and CSR Attention](https://arxiv.org/abs/2511.17594) <a id="link12"></a>
...
**Comment:** ML Systems/HPC: input-aware CUDA scheduling for sparse SpMM/SDDMM and CSR attention with on-device micro-probes and reproducible kernels.
...
**Comment:** Representation Learning / Theory of Transformers: provable learnability of k-sparse Boolean functions with CoT under SFT vs RL, elucidating training dynamics differences.
...
## 14. [SAOT: An Enhanced Locality-Aware Spectral Transformer for Solving PDEs](https://arxiv.org/abs/2511.18777) <a id="link14"></a>
...
**Comment:** Model Architecture—Transformer innovation with Wavelet Attention (linear complexity) and hybrid spectral operator design.
...
## 15. [Internalizing Tools as Morphisms in Graded Transformers](https://arxiv.org/abs/2511.17840) <a id="link15"></a>
...
**Comment:** Model architecture: graded Transformer with typed morphisms and utility-aware sparse routing; algebraic/geometry-based framework for internal tool use.
...
## 16. [Gate-level boolean evolutionary geometric attention neural networks](https://arxiv.org/abs/2511.17550) <a id="link16"></a>
...
**Comment:** Model Architecture: introduces a fully Boolean self-attention Transformer with XNOR-based Q–K attention and Boolean RoPE; emphasizes discrete, hardware-efficient architectural design.
...
## 17. [Categorical Equivariant Deep Learning: Category-Equivariant Neural Networks and Universal Approximation Theorems](https://arxiv.org/abs/2511.18417) <a id="link17"></a>
...
**Comment:** Model Architecture + Representation Learning: unifies equivariant neural architectures via categorical naturality and proves universal approximation theorems.
...
## 18. [Deterministic Inference across Tensor Parallel Sizes That Eliminates Training-Inference Mismatch](https://arxiv.org/abs/2511.17826) <a id="link18"></a>
...
**Comment:** ML Systems/HPC: tree-based TP-invariant matmul/reduction kernels guaranteeing bitwise determinism across tensor-parallel sizes; resolves training–inference mismatch with theoretical/empirical validation.
...
## 19. [CDLM: Consistency Diffusion Language Models For Faster Sampling](https://arxiv.org/abs/2511.19269) <a id="link19"></a>
...
**Comment:** Compression/Efficiency + Inference Systems: consistency modeling for multi-token finalization and block-wise causal masking to enable KV cache, yielding large latency reductions in DLMs.
...
## 20. [Masked Diffusion Models are Secretly Learned-Order Autoregressive Models](https://arxiv.org/abs/2511.19152) <a id="link20"></a>
...
**Comment:** Representation Learning/Theory: proves MDM objectives decompose into weighted autoregressive losses with learnable decoding order via multivariate noise schedules.
...
## 21. [Nemotron-Flash: Towards Latency-Optimal Hybrid Small Language Models](https://arxiv.org/abs/2511.18890) <a id="link21"></a>
...
**Comment:** Model Architecture and ML Systems/Efficiency: analyzes depth–width and operator choices for latency, uses evolutionary search and training tweaks to build latency-optimal SLMs with real-device throughput/latency gains.
...
## 22. [From Tables to Signals: Revealing Spectral Adaptivity in TabPFN](https://arxiv.org/abs/2511.18278) <a id="link22"></a>
...
**Comment:** Representation Learning: frequency-based analysis of TabPFN’s in-context learning revealing spectral adaptivity and inductive biases.
...
## 23. [OrdMoE: Preference Alignment via Hierarchical Expert Group Ranking in Multimodal Mixture-of-Experts LLMs](https://arxiv.org/abs/2511.19023) <a id="link23"></a>
...
**Comment:** Model Architecture (MoE): leverages router expert scores to form a hierarchical expert-tier ranking for self-supervised preference learning in MoE LLMs; insight into routing/gating behavior.
...
## 24. [GateRA: Token-Aware Modulation for Parameter-Efficient Fine-Tuning](https://arxiv.org/abs/2511.17582) <a id="link24"></a>
...
**Comment:** Compression/Efficiency + PEFT: token-aware gating modulates low-rank updates per token with entropy regularization; includes theoretical view as soft gradient masking.
...
## 25. [Deterministic Continuous Replacement: Fast and Stable Module Replacement in Pretrained Transformers](https://arxiv.org/abs/2511.18670) <a id="link25"></a>
...
**Comment:** Model architecture/training: deterministic continuous replacement to stably swap self-attention with efficient operators in pretrained Transformers; reduces gradient variance vs stochastic gating.
...
## 26. [VLM in a flash: I/O-Efficient Sparsification of Vision-Language Model via Neuron Chunking](https://arxiv.org/abs/2511.18692) <a id="link26"></a>
...
**Comment:** ML systems/I-O optimization: I/O-aware activation sparsification via neuron chunking aligned to flash access contiguity for offloaded VLMs.
...
## 27. [Understanding Counting Mechanisms in Large Language and Vision-Language Models](https://arxiv.org/abs/2511.17699) <a id="link27"></a>
...
**Comment:** Representation Learning: mechanistic interpretability of counting via causal mediation and activation patching, revealing layerwise numerical representations in LLMs/LVLMs.
...
## 28. [FastForward Pruning: Efficient LLM Pruning via Single-Step Reinforcement Learning](https://arxiv.org/abs/2511.18977) <a id="link28"></a>
...
**Comment:** Model Compression and Efficiency: RL-based single-step framework for non-uniform pruning policies in LLMs with improved search efficiency.
...
## 29. [Controllability Analysis of State Space-based Language Model](https://arxiv.org/abs/2511.17970) <a id="link29"></a>
...
**Comment:** Representation Learning/Architecture Analysis: controllability-derived Influence Score to interpret state-space (Mamba) language models’ internal dynamics.
...
## 30. [Using MLIR Transform to Design Sliced Convolution Algorithm](https://arxiv.org/abs/2511.18222) <a id="link30"></a>
...
**Comment:** Compiler/codegen: MLIR Transform dialect extension for convolution tiling/packing via declarative affine analyses; generalizable systems optimization for kernels.
...
## 31. [Understanding the Staged Dynamics of Transformers in Learning Latent Structure](https://arxiv.org/abs/2511.19328) <a id="link31"></a>
...
**Comment:** Representation Learning / Training Dynamics: provides granular analysis of staged capability acquisition in transformers when learning latent structure.
...
## 32. [Doubly Wild Refitting: Model-Free Evaluation of High Dimensional Black-Box Predictions under Convex Losses](https://arxiv.org/abs/2511.18789) <a id="link32"></a>
...
**Comment:** Representation Learning / Theory: model-free excess risk evaluation via doubly wild refitting for general convex losses; broadly applicable, black-box evaluation method.
...
## 33. [Understanding Private Learning From Feature Perspective](https://arxiv.org/abs/2511.18006) <a id="link33"></a>
...
**Comment:** Representation Learning / Theory: feature-learning perspective on DP-SGD, distinguishing label-dependent signal vs label-independent noise with theoretical characterization of SNR and memorization.
...
## 34. [Resolving Node Identifiability in Graph Neural Processes via Laplacian Spectral Encodings](https://arxiv.org/abs/2511.19037) <a id="link34"></a>
...
**Comment:** Model Architecture & Representation Learning: principled Laplacian spectral positional encodings (invariant to sign flips/eigenspace rotations) with theory on node identifiability and sample-complexity improvements.
...
## 35. [Fast Escape, Slow Convergence: Learning Dynamics of Phase Retrieval under Power-Law Data](https://arxiv.org/abs/2511.18661) <a id="link35"></a>
...
**Comment:** Training dynamics/scaling laws: analytic characterization of learning phases and error scaling in nonlinear phase retrieval with anisotropic, power-law spectra.
...
## 36. [Information Physics of Intelligence: Unifying Logical Depth and Entropy under Thermodynamic Constraints](https://arxiv.org/abs/2511.19156) <a id="link36"></a>
...
**Comment:** Model Efficiency Theory: introduces Derivation Entropy linking Shannon entropy and computational complexity to bound storage–compute tradeoffs for AI architectures.
...
## 37. [Escaping Optimization Stagnation: Taking Steps Beyond Task Arithmetic via Difference Vectors](https://arxiv.org/abs/2511.17987) <a id="link37"></a>
...
**Comment:** Optimization/Model Editing: introduces difference vectors and DV-BASI to extend task arithmetic for parameter-efficient model merging and fine-tuning.
...
## 38. [Weighted Birkhoff Averages Accelerate Data-Driven Methods](https://arxiv.org/abs/2511.17772) <a id="link38"></a>
...
**Comment:** Algorithmic efficiency/representation learning: weighted Birkhoff averages accelerate data-driven methods (e.g., DMD, EDMD, SINDy) with markedly faster convergence.
...
## 39. [Equivariant Deep Equilibrium Models for Imaging Inverse Problems](https://arxiv.org/abs/2511.18667) <a id="link39"></a>
...
**Comment:** Model architecture/training: Equivariant Deep Equilibrium Models with implicit differentiation; insights into training dynamics under symmetry constraints.
...
## 40. [How Learning Rate Decay Wastes Your Best Data in Curriculum-Based LLM Pretraining](https://arxiv.org/abs/2511.18903) <a id="link40"></a>
...
**Comment:** Representation Learning / Training Dynamics: analyzes incompatibility between curriculum ordering and learning-rate decay; ML-Systems co-design insight between data curriculum and optimization schedule.
...
## 41. [Curvature-Aware Safety Restoration In LLMs Fine-Tuning](https://arxiv.org/abs/2511.18039) <a id="link41"></a>
...
**Comment:** Representation Learning / Training Dynamics: curvature-aware safety restoration using influence functions and second-order optimization to preserve task performance while restoring alignment.
...
## 42. [Transforming Conditional Density Estimation Into a Single Nonparametric Regression Task](https://arxiv.org/abs/2511.18530) <a id="link42"></a>
...
**Comment:** Representation Learning—foundational method transforming conditional density estimation to a single regression task with theoretical convergence.
...
## 43. [Plan-X: Instruct Video Generation via Semantic Planning](https://arxiv.org/abs/2511.17986) <a id="link43"></a>
...
**Comment:** Model Architecture—semantic planner guiding diffusion via text-grounded spatio-temporal tokens (conditional/dynamic control for video generation).
...
## 44. [Physics-informed Neural Operator Learning for Nonlinear Grad-Shafranov Equation](https://arxiv.org/abs/2511.19114) <a id="link44"></a>
...
**Comment:** Model Architecture—Physics-Informed Neural Operator with Transformer–KAN hybrid and semi-supervised physics-constrained training for efficient inference.
...
## 45. [MapFormer: Self-Supervised Learning of Cognitive Maps with Input-Dependent Positional Embeddings](https://arxiv.org/abs/2511.19279) <a id="link45"></a>
...
**Comment:** Model Architecture: introduces input-dependent positional embeddings in Transformers and unifies absolute/relative PE for structure–content disentanglement; Representation Learning via self-supervised cognitive map induction with strong OOD generalization.
...
## 46. [Frugality in second-order optimization: floating-point approximations for Newton's method](https://arxiv.org/abs/2511.17660) <a id="link46"></a>
...
**Comment:** Optimization & Efficiency: mixed-precision analysis and convergence for Newton-type methods; GN_k reduces second-order computation—relevant to efficient large-scale training.
...
**Comment:** ML Systems/HPC: kernel optimization via a hierarchical, hardware-aware multi-armed bandit guiding LLM codegen; uses profiling and clustering to balance exploration/exploitation.
...
## 48. [Subtract the Corruption: Training-Data-Free Corrective Machine Unlearning using Task Arithmetic](https://arxiv.org/abs/2511.18660) <a id="link48"></a>
...
**Comment:** ML systems/unlearning: source-free corrective machine unlearning via task arithmetic in weight space (no training data or forget set).
...
## 49. [Accelerating Time Series Foundation Models with Speculative Decoding](https://arxiv.org/abs/2511.18191) <a id="link49"></a>
...
**Comment:** ML Systems + Efficiency: adapts speculative decoding to continuous time-series autoregressive models with parallel verification and acceptance criteria.
...
## 50. [EnfoPath: Energy-Informed Analysis of Generative Trajectories in Flow Matching](https://arxiv.org/abs/2511.19087) <a id="link50"></a>
...
**Comment:** Representation Learning/Training Dynamics: proposes kinetic path energy to analyze ODE sampling trajectories in flow matching, linking trajectory energy to semantic quality and data density.
...
## 51. [DeepCoT: Deep Continual Transformers for Real-Time Inference on Data Streams](https://arxiv.org/abs/2511.17693) <a id="link51"></a>
...
**Comment:** Model Architecture + Efficiency: continual Transformer design for streaming inference with redundancy elimination and linear cost across all layers.
...
## 52. [Comprehensive Design Space Exploration for Tensorized Neural Network Hardware Accelerators](https://arxiv.org/abs/2511.17971) <a id="link52"></a>
...
**Comment:** ML Systems: unified co-exploration of contraction path, hardware architecture, and dataflow mapping (algorithm–system co-design) with a latency-driven objective and FPGA-backed gains.
...
## 53. [Adaptive Mesh-Quantization for Neural PDE Solvers](https://arxiv.org/abs/2511.18474) <a id="link53"></a>
...
**Comment:** Model Compression and Efficiency: spatially adaptive quantization with dynamic bit-width allocation over mesh nodes/edges guided by an auxiliary model; dynamic precision for GNN-based PDE solvers.
...
## 54. [Rectifying Soft-Label Entangled Bias in Long-Tailed Dataset Distillation](https://arxiv.org/abs/2511.17914) <a id="link54"></a>
...
**Comment:** Compression/Efficiency: advances dataset distillation under long-tailed distributions with an imbalance-aware generalization bound and an adaptive soft-label alignment module.
