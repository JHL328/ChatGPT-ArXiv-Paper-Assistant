...
2. [Higher-order Linear Attention](#user-content-link2)
**Authors:** Yifan Zhang, Zhen Qin, Quanquan Gu

3. [TetraJet-v2: Accurate NVFP4 Training for Large Language Models with Oscillation Suppression and Outlier Control](#user-content-link3)
**Authors:** Yuxiang Chen, Xiaoming Xu, Pengle Zhang, Michael Beyer, Martin Rapp, Jun Zhu, Jianfei Chen

4. [A Proof of Learning Rate Transfer under $\mu$P](#user-content-link4)
**Authors:** Soufiane Hayou

5. [Regularization Implies balancedness in the deep linear network](#user-content-link5)
**Authors:** Kathryn Lindsey, Govind Menon

6. [Belief Dynamics Reveal the Dual Nature of In-Context Learning and Activation Steering](#user-content-link6)
**Authors:** Eric Bigelow, Daniel Wurgaft, YingQiao Wang, Noah Goodman, Tomer Ullman, Hidenori Tanaka, Ekdeep Singh Lubana

7. [AReaL-Hex: Accommodating Asynchronous RL Training over Heterogeneous GPUs](#user-content-link7)
**Authors:** Ran Yan, Youhe Jiang, Tianyuan Wu, Jiaxuan Gao, Zhiyu Mei, Wei Fu, Haohui Mai, Wei Wang, Yi Wu, Binhang Yuan

8. [Reject Only Critical Tokens: Pivot-Aware Speculative Decoding](#user-content-link8)
**Authors:** Amir Ziashahabi, Yavuz Faruk Bakman, Duygu Nur Yaldiz, Mostafa El-Khamy, Sai Praneeth Karimireddy, Salman Avestimehr

9. [Loquetier: A Virtualized Multi-LoRA Framework for Unified LLM Fine-tuning and Serving](#user-content-link9)
**Authors:** Yuchen Zhang, Hanyue Du, Chun Cao, Jingwei Xu

10. [Analyzing the Power of Chain of Thought through Memorization Capabilities](#user-content-link10)
**Authors:** Lijia Yu, Xiao-Shan Gao, Lijun Zhang

11. [Priors in Time: Missing Inductive Biases for Language Model Interpretability](#user-content-link11)
...
12. [FlexiCache: Leveraging Temporal Stability of Attention Heads for Efficient KV Cache Management](#user-content-link12)
**Authors:** Nazmul Takbir, Hamidreza Alikhani, Nikil Dutt, Sangeetha Abdu Jyothi

13. [Memory-Efficient Training with In-Place FFT Implementation](#user-content-link13)
**Authors:** Xinyu Ding, Bangtian Liu, Siyu Liao, Zhongfeng Wang

14. [Optimal Attention Temperature Enhances In-Context Learning under Distribution Shift](#user-content-link14)
**Authors:** Samet Demir, Zafer Dogan

15. [CAS-Spec: Cascade Adaptive Self-Speculative Decoding for On-the-Fly Lossless Inference Acceleration of LLMs](#user-content-link15)
**Authors:** Zhiyuan Ning, Jiawei Shao, Ruge Xu, Xinfei Guo, Jun Zhang, Chi Zhang, Xuelong Li

16. [The Hidden Power of Normalization: Exponential Capacity Control in Deep Neural Networks](#user-content-link16)
**Authors:** Khoat Than

17. [Tree Training: Accelerating Agentic LLMs Training via Shared Prefix Reuse](#user-content-link17)
...
18. [Energy-Efficient Deep Learning Without Backpropagation: A Rigorous Evaluation of Forward-Only Algorithms](#user-content-link18)
**Authors:** Przemys{\l}aw Spyra, Witold Dzwinel

19. [Training with Fewer Bits: Unlocking Edge LLMs Training with Stochastic Rounding](#user-content-link19)
**Authors:** Taowen Liu, Marta Andronic, Deniz G\"und\"uz, George A. Constantinides

20. [MISA: Memory-Efficient LLMs Optimization with Module-wise Importance Sampling](#user-content-link20)
**Authors:** Yuxi Liu, Renjia Deng, Yutong He, Xue Wang, Tao Yao, Kun Yuan

21. [Calibrating and Rotating: A Unified Framework for Weight Conditioning in PEFT](#user-content-link21)
**Authors:** Da Chang, Peng Xue, Yu Li, Yongxiang Liu, Pengxiang Xu, Shixun Zhang

22. [LongCat-Flash-Omni Technical Report](#user-content-link22)
...
23. [Transformers as Intrinsic Optimizers: Forward Inference through the Energy Principle](#user-content-link23)
**Authors:** Ruifeng Ren, Sheng Ouyang, Huayi Tang, Yong Liu

24. [Calibration Across Layers: Understanding Calibration Evolution in LLMs](#user-content-link24)
**Authors:** Abhinav Joshi, Areeb Ahmad, Ashutosh Modi

25. [Soft Task-Aware Routing of Experts for Equivariant Representation Learning](#user-content-link25)
**Authors:** Jaebyeong Jeon, Hyeonseo Jang, Jy-yong Sohn, Kibok Lee

26. [From Uniform to Adaptive: General Skip-Block Mechanisms for Efficient PDE Neural Operators](#user-content-link26)
**Authors:** Lei Liu, Zhongyi Yu, Hong Wang, Huanshuo Dong, Haiyang Xin, Hongwei Zhao, Bin Li

27. [Feature-Function Curvature Analysis: A Geometric Framework for Explaining Differentiable Models](#user-content-link27)
**Authors:** Hamed Najafi, Dongsheng Luo, Jason Liu

28. [MotionStream: Real-Time Video Generation with Interactive Motion Controls](#user-content-link28)
**Authors:** Joonghyuk Shin, Zhengqi Li, Richard Zhang, Jun-Yan Zhu, Jaesik Park, Eli Schechtman, Xun Huang

29. [Isotropic Curvature Model for Understanding Deep Learning Optimization: Is Gradient Orthogonalization Optimal?](#user-content-link29)
**Authors:** Weijie Su

30. [A Saddle Point Remedy: Power of Variable Elimination in Non-convex Optimization](#user-content-link30)
**Authors:** Min Gan, Guang-Yong Chen, Yang Yi, Lin Yang

31. [Fints: Efficient Inference-Time Personalization for LLMs with Fine-Grained Instance-Tailored Steering](#user-content-link31)
**Authors:** Kounianhua Du, Jianxing Liu, Kangning Zhang, Wenxiang Jiao, Yuan Lu, Jiarui Jin, Weiwen Liu, Yong Yu, Weinan Zhang

32. [Atlas-Alignment: Making Interpretability Transferable Across Language Models](#user-content-link32)
**Authors:** Bruno Puri, Jim Berend, Sebastian Lapuschkin, Wojciech Samek

33. [Hydra: Dual Exponentiated Memory for Multivariate Time Series Analysis](#user-content-link33)
**Authors:** Asal Meskin, Alireza Mirrokni, Ali Najar, Ali Behrouz

34. [Scaling Graph Chain-of-Thought Reasoning: A Multi-Agent Framework with Efficient LLM Serving](#user-content-link34)
...
35. [H2-Cache: A Novel Hierarchical Dual-Stage Cache for High-Performance Acceleration of Generative Diffusion Models](#user-content-link35)
**Authors:** Mingyu Sung, Il-Min Kim, Sangseok Yun, Jae-Mo Kang

36. [LL-ViT: Edge Deployable Vision Transformers with Look Up Table Neurons](#user-content-link36)
...
37. [Game-theoretic distributed learning of generative models for heterogeneous data collections](#user-content-link37)
**Authors:** Dmitrij Schlesinger, Boris Flach

38. [Bridging Lifelong and Multi-Task Representation Learning via Algorithm and Complexity Measure](#user-content-link38)
**Authors:** Zhi Wang, Chicheng Zhang, Ramya Korlakai Vinayak

39. [Thought Branches: Interpreting LLM Reasoning Requires Resampling](#user-content-link39)
**Authors:** Uzay Macar, Paul C. Bogdan, Senthooran Rajamanoharan, Neel Nanda

40. [Multi-Step Knowledge Interaction Analysis via Rank-2 Subspace Disentanglement](#user-content-link40)
**Authors:** Sekh Mainul Islam, Pepa Atanasova, Isabelle Augenstein

41. [Random Spiking Neural Networks are Stable and Spectrally Simple](#user-content-link41)
**Authors:** Ernesto Araya, Massimiliano Datres, Gitta Kutyniok

42. [A Retrospect to Multi-prompt Learning across Vision and Language](#user-content-link42)
**Authors:** Ziliang Chen, Xin Huang, Quanlong Guan, Liang Lin, Weiqi Luo

43. [ReLaX-Net: Reusing Layers for Parameter-Efficient Physical Neural Networks](#user-content-link43)
**Authors:** Kohei Tsuchiyama, Andre Roehm, Takatomo Mihana, Ryoichi Horisaki

44. [Information-Theoretic Greedy Layer-wise Training for Traffic Sign Recognition](#user-content-link44)
**Authors:** Shuyan Lyu, Zhanzimo Wu, Junliang Du

45. [DeepCompress: A Dual Reward Strategy for Dynamically Exploring and Compressing Reasoning Chains](#user-content-link45)
**Authors:** Tian Liang, Wenxiang Jiao, Zhiwei He, Jiahao Xu, Haitao Mi, Dong Yu

46. [Learning with Category-Equivariant Architectures for Human Activity Recognition](#user-content-link46)
...
**Comment:** Model Architecture + Model Compression and Efficiency—replaces next-token with next-vector prediction via a high-fidelity autoencoder, reducing generation steps K-fold and providing a likelihood-free continuous modeling toolkit.
...
## 2. [Higher-order Linear Attention](https://arxiv.org/abs/2510.27258) <a id="link2"></a>
...
**Comment:** Model Architecture and Efficiency: higher-order linear attention with constant-size streaming state and exact chunk-parallel scans, offering scalable attention-like mixing beyond first order.
...
## 3. [TetraJet-v2: Accurate NVFP4 Training for Large Language Models with Oscillation Suppression and Outlier Control](https://arxiv.org/abs/2510.27527) <a id="link3"></a>
...
**Comment:** Model Compression and Efficiency: fully-quantized 4-bit training with NVFP4 for weights/activations/gradients; introduces oscillation suppression and outlier control for stable LLM training.
...
## 4. [A Proof of Learning Rate Transfer under $\mu$P](https://arxiv.org/abs/2511.01734) <a id="link4"></a>
...
**Comment:** Training dynamics/architecture theory: first proof of learning-rate transfer under μP with width, explaining non-vanishing optimal LR and contrasting with SP/NTP.
...
## 5. [Regularization Implies balancedness in the deep linear network](https://arxiv.org/abs/2511.01137) <a id="link5"></a>
...
**Comment:** Representation Learning/Theory: proves L2 regularization drives balancedness in deep linear nets via GIT (Kempf–Ness), decomposing training into regularizing vs learning flows.
...
## 6. [Belief Dynamics Reveal the Dual Nature of In-Context Learning and Activation Steering](https://arxiv.org/abs/2511.00617) <a id="link6"></a>
...
**Comment:** Representation Learning/Theory: unified Bayesian account linking in-context learning and activation steering via latent concept beliefs; predictive model of intervention effects.
...
## 7. [AReaL-Hex: Accommodating Asynchronous RL Training over Heterogeneous GPUs](https://arxiv.org/abs/2511.00796) <a id="link7"></a>
...
**Comment:** ML Systems/HPC: heterogeneity-aware asynchronous RL training with MILP-based stage parallelization and graph-partitioning across heterogeneous GPUs; improves throughput/cost under staleness bounds.
...
## 8. [Reject Only Critical Tokens: Pivot-Aware Speculative Decoding](https://arxiv.org/abs/2511.00351) <a id="link8"></a>
...
**Comment:** Model Efficiency (Decoding): pivot-aware speculative decoding relaxes distribution-matching to utility-preserving acceptance, using a classifier to reject only critical tokens, enabling up to 2.5× speedups.
...
## 9. [Loquetier: A Virtualized Multi-LoRA Framework for Unified LLM Fine-tuning and Serving](https://arxiv.org/abs/2511.00101) <a id="link9"></a>
...
**Comment:** ML Systems: unified runtime for multi-LoRA fine-tuning and serving via virtualized adapter modules and fused forward-path kernels enabling efficient co-serving, batching, and high throughput.
...
## 10. [Analyzing the Power of Chain of Thought through Memorization Capabilities](https://arxiv.org/abs/2511.01190) <a id="link10"></a>
...
**Comment:** Foundational Theory of Model Architecture/Training Dynamics: necessary/sufficient conditions and parameter bounds for transformers with/without CoT to memorize datasets.
...
## 11. [Priors in Time: Missing Inductive Biases for Language Model Interpretability](https://arxiv.org/abs/2511.01836) <a id="link11"></a>
...
**Comment:** Representation Learning/Interpretability: introduces Temporal Feature Analysis with temporal inductive biases, addressing non-stationarity that SAEs miss.
...
## 12. [FlexiCache: Leveraging Temporal Stability of Attention Heads for Efficient KV Cache Management](https://arxiv.org/abs/2511.00868) <a id="link12"></a>
...
**Comment:** ML Systems/Efficiency: hierarchical KV-cache management exploiting attention-head temporal stability with GPU/host paging and periodic re-ranking, yielding lower memory and latency.
...
## 13. [Memory-Efficient Training with In-Place FFT Implementation](https://arxiv.org/abs/2511.01385) <a id="link13"></a>
...
**Comment:** ML Systems: kernel-level in-place real FFT enabling memory-consistent, cache-free transforms for training; improves memory efficiency via algorithm–system co-design.
...
## 14. [Optimal Attention Temperature Enhances In-Context Learning under Distribution Shift](https://arxiv.org/abs/2511.01292) <a id="link14"></a>
...
**Comment:** Model architecture/ICL theory: analyzes softmax attention temperature, proving existence of an optimal temperature under distribution shift and validating on Transformers.
...
## 15. [CAS-Spec: Cascade Adaptive Self-Speculative Decoding for On-the-Fly Lossless Inference Acceleration of LLMs](https://arxiv.org/abs/2510.26843) <a id="link15"></a>
...
**Comment:** ML Systems + Efficiency: on-the-fly self-speculative decoding with cascaded draft models via layer sparsity and activation quantization, plus a dynamic tree cascade routing algorithm.
...
## 16. [The Hidden Power of Normalization: Exponential Capacity Control in Deep Neural Networks](https://arxiv.org/abs/2511.00958) <a id="link16"></a>
...
**Comment:** Representation learning theory: shows normalization exponentially reduces Lipschitz constants, yielding capacity control and smoother loss landscapes for optimization/generalization.
...
## 17. [Tree Training: Accelerating Agentic LLMs Training via Shared Prefix Reuse](https://arxiv.org/abs/2511.00413) <a id="link17"></a>
...
**Comment:** ML Systems/HPC: shared-prefix reuse across tree-structured trajectories (Tree Packing + Gradient Restoration) enabling forward/backward compute reuse and substantial training speedups.
...
## 18. [Energy-Efficient Deep Learning Without Backpropagation: A Rigorous Evaluation of Forward-Only Algorithms](https://arxiv.org/abs/2511.01061) <a id="link18"></a>
...
**Comment:** Training efficiency: forward-only learning (MF) as a backprop alternative with hardware-validated energy and speed gains; contributes to foundational training algorithms.
...
## 19. [Training with Fewer Bits: Unlocking Edge LLMs Training with Stochastic Rounding](https://arxiv.org/abs/2511.00874) <a id="link19"></a>
...
**Comment:** Model Compression and Efficiency: quantized training with stochastic rounding; analyzes batch-size–precision tradeoffs and gradient variance.
...
## 20. [MISA: Memory-Efficient LLMs Optimization with Module-wise Importance Sampling](https://arxiv.org/abs/2511.00056) <a id="link20"></a>
...
**Comment:** Matches Model Compression and Efficiency and ML Systems: proposes a memory-efficient training scheme via module-wise importance sampling with proven variance reduction, convergence guarantees, and memory analysis.
...
## 21. [Calibrating and Rotating: A Unified Framework for Weight Conditioning in PEFT](https://arxiv.org/abs/2511.00051) <a id="link21"></a>
...
**Comment:** Compression/Efficiency (PEFT): unified weight conditioning framework (Pre-Diag, SORA) with theoretical insight (singular value entropy) and orthogonal/diagonal transforms.
...
## 22. [LongCat-Flash-Omni Technical Report](https://arxiv.org/abs/2511.00279) <a id="link22"></a>
...
**Comment:** Model Architecture: Shortcut-connected MoE with zero-computation experts; ML Systems: modality-decoupled parallelism for large-scale multimodal training with throughput analysis.
...
## 23. [Transformers as Intrinsic Optimizers: Forward Inference through the Energy Principle](https://arxiv.org/abs/2511.00907) <a id="link23"></a>
...
**Comment:** Model Architecture — unified energy-based formulation of attention and new attention variants (momentum/NAG/Newton) derived from optimization principles.
...
## 24. [Calibration Across Layers: Understanding Calibration Evolution in LLMs](https://arxiv.org/abs/2511.00280) <a id="link24"></a>
...
**Comment:** Representation Learning: analyzes calibration evolution across layers and finds a low-dimensional residual-stream direction improving ECE/MCE without accuracy loss.
...
## 25. [Soft Task-Aware Routing of Experts for Equivariant Representation Learning](https://arxiv.org/abs/2510.27222) <a id="link25"></a>
...
**Comment:** Model Architecture (MoE/conditional routing): soft task-aware expert routing between invariant/equivariant heads reduces redundancy in representations.
...
## 26. [From Uniform to Adaptive: General Skip-Block Mechanisms for Efficient PDE Neural Operators](https://arxiv.org/abs/2511.00032) <a id="link26"></a>
...
**Comment:** Model Architecture + Efficiency: conditional token routing/pruning (Skip-Block Routing) in Transformer-based neural operators yielding ~50% FLOP reduction.
...
## 27. [Feature-Function Curvature Analysis: A Geometric Framework for Explaining Differentiable Models](https://arxiv.org/abs/2510.27207) <a id="link27"></a>
...
**Comment:** Representation Learning—Feature-Function Curvature Analysis quantifies impact/nonlinearity/interaction and tracks training dynamics, yielding diagnostics and evidence of hierarchical learning.
...
## 28. [MotionStream: Real-Time Video Generation with Interactive Motion Controls](https://arxiv.org/abs/2511.01266) <a id="link28"></a>
...
**Comment:** Architecture/Efficiency — sliding-window causal attention with attention sinks and KV-cache rolling for constant-speed, infinite-horizon streaming generation.
...
## 29. [Isotropic Curvature Model for Understanding Deep Learning Optimization: Is Gradient Orthogonalization Optimal?](https://arxiv.org/abs/2511.00674) <a id="link29"></a>
...
**Comment:** Optimization/Training Dynamics — isotropic curvature model explains/assesses gradient orthogonalization (Muon) and prescribes matrix-gradient updates.
...
## 30. [A Saddle Point Remedy: Power of Variable Elimination in Non-convex Optimization](https://arxiv.org/abs/2511.01234) <a id="link30"></a>
...
**Comment:** Optimization/Training Dynamics: variable elimination (VarPro) provably transforms saddle points via Hessian inertia/Schur complement analysis, improving robustness and convergence in deep nets.
...
## 31. [Fints: Efficient Inference-Time Personalization for LLMs with Fine-Grained Instance-Tailored Steering](https://arxiv.org/abs/2510.27206) <a id="link31"></a>
...
**Comment:** Matches Model Architecture/Efficiency: inference-time personalization via activation hooking and instance-tailored steering vectors; a plug-in mechanism compatible with various personalization methods.
...
## 32. [Atlas-Alignment: Making Interpretability Transferable Across Language Models](https://arxiv.org/abs/2510.27413) <a id="link32"></a>
...
**Comment:** Representation Learning/Interpretability: representational alignment to a Concept Atlas enabling transferable feature retrieval and steerable generation across models.
...
## 33. [Hydra: Dual Exponentiated Memory for Multivariate Time Series Analysis](https://arxiv.org/abs/2511.00989) <a id="link33"></a>
...
**Comment:** Model Architecture: 2D recurrent memory across time and variate; Efficiency: 2D chunk-wise training approximates recurrence with ~10x speedup.
...
## 34. [Scaling Graph Chain-of-Thought Reasoning: A Multi-Agent Framework with Efficient LLM Serving](https://arxiv.org/abs/2511.01633) <a id="link34"></a>
...
**Comment:** ML Systems — introduces Graph-CoT–aware LLM serving with graph-specific KV-cache management (priority-based eviction) and pipelined execution for high-throughput, low-latency inference.
...
## 35. [H2-Cache: A Novel Hierarchical Dual-Stage Cache for High-Performance Acceleration of Generative Diffusion Models](https://arxiv.org/abs/2510.27171) <a id="link35"></a>
...
**Comment:** ML Systems/Efficiency — hierarchical dual-stage cache with lightweight pooled feature summarization to accelerate diffusion inference with minimal quality loss.
...
## 36. [LL-ViT: Edge Deployable Vision Transformers with Look Up Table Neurons](https://arxiv.org/abs/2511.00812) <a id="link36"></a>
...
**Comment:** Model Compression and Efficiency: integrates LUT-based channel mixers into ViT to remove multiplications and shrink weights; ML Systems: FPGA hardware–software co-design with measured latency/energy gains.
...
## 37. [Game-theoretic distributed learning of generative models for heterogeneous data collections](https://arxiv.org/abs/2511.01740) <a id="link37"></a>
...
**Comment:** ML Systems (distributed training): game-theoretic data-exchange protocol enabling heterogeneous local models with convergence to a unique Nash equilibrium; generalizable beyond a single modality.
...
## 38. [Bridging Lifelong and Multi-Task Representation Learning via Algorithm and Complexity Measure](https://arxiv.org/abs/2511.01847) <a id="link38"></a>
...
**Comment:** Representation learning theory: introduces task-eluder dimension and a lifelong algorithm with sample-complexity guarantees for learning shared representations across tasks.
...
## 39. [Thought Branches: Interpreting LLM Reasoning Requires Resampling](https://arxiv.org/abs/2510.27484) <a id="link39"></a>
...
**Comment:** Representation Learning: studies distributions over chains-of-thought via resampling for causal analysis, yielding insights into LLM reasoning dynamics and principled interventions.
...
## 40. [Multi-Step Knowledge Interaction Analysis via Rank-2 Subspace Disentanglement](https://arxiv.org/abs/2511.01706) <a id="link40"></a>
...
**Comment:** Representation Learning: rank-2 subspace disentanglement to separate parametric vs context knowledge across multi-step NLEs, providing grounded analysis of knowledge interactions.
...
## 41. [Random Spiking Neural Networks are Stable and Spectrally Simple](https://arxiv.org/abs/2511.00904) <a id="link41"></a>
...
**Comment:** Representation learning theory: analyzes SNN stability via Fourier spectrum concentration and introduces spectral simplicity.
...
## 42. [A Retrospect to Multi-prompt Learning across Vision and Language](https://arxiv.org/abs/2511.00191) <a id="link42"></a>
...
**Comment:** Matches Model Architecture and Representation Learning: energy-based multi-prompt learning for VLMs with theoretical and empirical justification, aiming at parameter-efficient transfer.
...
## 43. [ReLaX-Net: Reusing Layers for Parameter-Efficient Physical Neural Networks](https://arxiv.org/abs/2511.00044) <a id="link43"></a>
...
**Comment:** Matches Model Architecture/Efficiency and hardware–software co-design: weight tying and time-multiplexed layer reuse (ReLaX-Net) to expand effective depth in physical neural networks with minimal parameter count.
...
## 44. [Information-Theoretic Greedy Layer-wise Training for Traffic Sign Recognition](https://arxiv.org/abs/2510.27651) <a id="link44"></a>
...
**Comment:** Matches Model Compression/Efficiency and Representation Learning: greedy layer-wise training via deterministic information bottleneck, avoiding backprop and reducing memory while learning minimal sufficient representations.
...
## 45. [DeepCompress: A Dual Reward Strategy for Dynamically Exploring and Compressing Reasoning Chains](https://arxiv.org/abs/2510.27419) <a id="link45"></a>
...
**Comment:** Efficiency: dual reward strategy that adaptively compresses or extends chain-of-thought lengths, improving token efficiency without sacrificing accuracy.
...
## 46. [Learning with Category-Equivariant Architectures for Human Activity Recognition](https://arxiv.org/abs/2511.01139) <a id="link46"></a>
...
**Comment:** Model Architecture: category-equivariant network enforcing temporal/gain/structure symmetries via a categorical symmetry product (equivariance design).
