...
1. [From Models to Operators: Rethinking Autoscaling Granularity for Large Generative Models](#user-content-link1)
**Authors:** Xingqi Cui, Chieh-Jan Mike Liang, Jiarong Xing, Haoran Qiu

2. [FP8-Flow-MoE: A Casting-Free FP8 Recipe without Double Quantization Error](#user-content-link2)
**Authors:** Fengjuan Wang, Zhiyi Su, Xingzhu Hu, Cheng Wang, Mou Sun

3. [Eliminating Multi-GPU Performance Taxes: A Systems Approach to Efficient Distributed LLMs](#user-content-link3)
...
4. [LongCat-Flash-Omni Technical Report](#user-content-link4)
...
5. [Optimizing Attention on GPUs by Exploiting GPU Architectural NUMA Effects](#user-content-link5)
**Authors:** Mansi Choudhary, Karthik Sangaiah, Sonali Singh, Muhammad Osama, Lisa Wu Wills, Ganesh Dasika

6. [MISA: Memory-Efficient LLMs Optimization with Module-wise Importance Sampling](#user-content-link6)
...
8. [Opportunistic Expert Activation: Batch-Aware Expert Routing for Faster Decode Without Retraining](#user-content-link8)
**Authors:** Costin-Andrei Oncescu, Qingyang Wu, Wai Tong Chung, Robert Wu, Bryan Gopal, Junxiong Wang, Tri Dao, Ben Athiwaratkun

9. [Flashlight: PyTorch Compiler Extensions to Accelerate Attention Variants](#user-content-link9)
...
10. [Language Modeling With Factorization Memory](#user-content-link10)
**Authors:** Lee Xiong, Maksim Tkachenko, Johanes Effendi, Ting Cai

11. [ExplicitLM: Decoupling Knowledge from Parameters via Explicit Memory Banks](#user-content-link11)
**Authors:** Chengzhang Yu, Zening Lu, Chenyang Zheng, Chiyue Wang, Yiming Zhang, Zhanpeng Jin

12. [Scalable Processing-Near-Memory for 1M-Token LLM Inference: CXL-Enabled KV-Cache Management Beyond GPU Limits](#user-content-link12)
...
13. [Calibrating and Rotating: A Unified Framework for Weight Conditioning in PEFT](#user-content-link13)
**Authors:** Da Chang, Peng Xue, Yu Li, Yongxiang Liu, Pengxiang Xu, Shixun Zhang

14. [CudaForge: An Agent Framework with Hardware Feedback for CUDA Kernel Optimization](#user-content-link14)
**Authors:** Zijian Zhang, Rong Wang, Shiyang Li, Yuebo Luo, Mingyi Hong, Caiwen Ding

15. [Scaling Graph Chain-of-Thought Reasoning: A Multi-Agent Framework with Efficient LLM Serving](#user-content-link15)
...
16. [Belief Dynamics Reveal the Dual Nature of In-Context Learning and Activation Steering](#user-content-link16)
**Authors:** Eric Bigelow, Daniel Wurgaft, YingQiao Wang, Noah Goodman, Tomer Ullman, Hidenori Tanaka, Ekdeep Singh Lubana

17. [Federated Attention: A Distributed Paradigm for Collaborative LLM Inference over Edge Networks](#user-content-link17)
**Authors:** Xiumei Deng, Zehui Xiong, Binbin Chen, Dong In Kim, Merouane Debbah, H. Vincent Poor

18. [A Proof of Learning Rate Transfer under $\mu$P](#user-content-link18)
**Authors:** Soufiane Hayou

19. [The Hidden Power of Normalization: Exponential Capacity Control in Deep Neural Networks](#user-content-link19)
**Authors:** Khoat Than

20. [How Focused Are LLMs? A Quantitative Study via Repetitive Deterministic Prediction Tasks](#user-content-link20)
**Authors:** Wanda Hou, Leon Zhou, Hong-Ye Hu, Yi-Zhuang You, Xiao-Liang Qi

21. [From Uniform to Adaptive: General Skip-Block Mechanisms for Efficient PDE Neural Operators](#user-content-link21)
**Authors:** Lei Liu, Zhongyi Yu, Hong Wang, Huanshuo Dong, Haiyang Xin, Hongwei Zhao, Bin Li

22. [Isotropic Curvature Model for Understanding Deep Learning Optimization: Is Gradient Orthogonalization Optimal?](#user-content-link22)
**Authors:** Weijie Su

23. [On the Emergence of Induction Heads for In-Context Learning](#user-content-link23)
**Authors:** Tiberiu Musat, Tiago Pimentel, Lorenzo Noci, Alessandro Stolfo, Mrinmaya Sachan, Thomas Hofmann

24. [Matrix Sensing with Kernel Optimal Loss: Robustness and Optimization Landscape](#user-content-link24)
**Authors:** Xinyuan Song, Jiaye Teng, Ziye Ma

25. [The stability of shallow neural networks on spheres: A sharp spectral analysis](#user-content-link25)
**Authors:** Xinliang Liu, Tong Mao, Jinchao Xu

26. [Optimal Singular Damage: Efficient LLM Inference in Low Storage Regimes](#user-content-link26)
**Authors:** Mohammadsajad Alipour, Mohammad Mohammadi Amiri

27. [When, What, and How: Rethinking Retrieval-Enhanced Speculative Decoding](#user-content-link27)
**Authors:** Min Fang, Zhihui Fu, Qibin Zhao, Jun Wang

28. [Apriel-H1: Towards Efficient Enterprise Reasoning Models](#user-content-link28)
...
29. [Dynamic Routing Between Experts: A Data-Efficient Approach to Continual Learning in Vision-Language Models](#user-content-link29)
**Authors:** Jay Mohta, Kenan Emir Ak, Dimitrios Dimitriadis, Yan Xu, Mingwei Shen

30. [Loquetier: A Virtualized Multi-LoRA Framework for Unified LLM Fine-tuning and Serving](#user-content-link30)
**Authors:** Yuchen Zhang, Hanyue Du, Chun Cao, Jingwei Xu

31. [Efficiently Training A Flat Neural Network Before It has been Quantizated](#user-content-link31)
**Authors:** Peng Xia, Junbiao Pang, Tianyang Cai

32. [Regularization Through Reasoning: Systematic Improvements in Language Model Classification via Explanation-Enhanced Fine-Tuning](#user-content-link32)
**Authors:** Vivswan Shah, Randy Cogill, Hanwei Yue, Gopinath Chennupati, Rinat Khaziev

33. [Real-time Continual Learning on Intel Loihi 2](#user-content-link33)
...
34. [Bulk-boundary decomposition of neural networks](#user-content-link34)
**Authors:** Donghee Lee, Hye-Sung Lee, Jaeok Yi

35. [Redundancy Maximization as a Principle of Associative Memory Learning](#user-content-link35)
...
36. [Efficient Vector Symbolic Architectures from Histogram Recovery](#user-content-link36)
**Authors:** Zirui Deng, Netanel Raviv

37. [Multi-Step Knowledge Interaction Analysis via Rank-2 Subspace Disentanglement](#user-content-link37)
**Authors:** Sekh Mainul Islam, Pepa Atanasova, Isabelle Augenstein

38. [In Good GRACEs: Principled Teacher Selection for Knowledge Distillation](#user-content-link38)
**Authors:** Abhishek Panigrahi, Bingbin Liu, Sadhika Malladi, Sham Kakade, Surbhi Goel

39. [Learning with Category-Equivariant Architectures for Human Activity Recognition](#user-content-link39)
**Authors:** Yoshihiro Maruyama

40. [Adam Reduces a Unique Form of Sharpness: Theoretical Insights Near the Minimizer Manifold](#user-content-link40)
**Authors:** Xinghan Li, Haodong Wen, Kaifeng Lyu

41. [A Non-Adversarial Approach to Idempotent Generative Modelling](#user-content-link41)
...
42. [Forget BIT, It is All about TOKEN: Towards Semantic Information Theory for LLMs](#user-content-link42)
**Authors:** Bo Bai

43. [Energy-Efficient Deep Learning Without Backpropagation: A Rigorous Evaluation of Forward-Only Algorithms](#user-content-link43)
**Authors:** Przemys{\l}aw Spyra, Witold Dzwinel

44. [Re-FORC: Adaptive Reward Prediction for Efficient Chain-of-Thought Reasoning](#user-content-link44)
**Authors:** Renos Zabounidis, Aditya Golatkar, Michael Kleinman, Alessandro Achille, Wei Xia, Stefano Soatto

45. [Shared Parameter Subspaces and Cross-Task Linearity in Emergently Misaligned Behavior](#user-content-link45)
**Authors:** Daniel Aarao Reis Arturi, Eric Zhang, Andrew Ansah, Kevin Zhu, Ashwinee Panda, Aishwarya Balwani

46. [Generalizing Test-time Compute-optimal Scaling as an Optimizable Graph](#user-content-link46)
**Authors:** Fali Wang, Jihai Chen, Shuhua Yang, Runxue Bao, Tianxiang Zhao, Zhiwei Zhang, Xianfeng Tang, Hui Liu, Qi He, Suhang Wang

47. [Neural network initialization with nonlinear characteristics and information on spectral bias](#user-content-link47)
**Authors:** Hikaru Homma, Jun Ohkubo

48. [RoME: Domain-Robust Mixture-of-Experts for MILP Solution Prediction across Domains](#user-content-link48)
**Authors:** Tianle Pu, Zijie Geng, Haoyang Liu, Shixuan Liu, Jie Wang, Li Zeng, Chao Chen, Changjun Fan

49. [Energy Loss Functions for Physical Systems](#user-content-link49)
**Authors:** S\'ekou-Oumar Kaba, Kusha Sareen, Daniel Levy, Siamak Ravanbakhsh

50. [ConMeZO: Adaptive Descent-Direction Sampling for Gradient-Free Finetuning of Large Language Models](#user-content-link50)
**Authors:** Lejs Deen Behric, Liang Zhang, Bingcong Li, Kiran Koshy Thekumparampil

51. [LLM Probing with Contrastive Eigenproblems: Improving Understanding and Applicability of CCS](#user-content-link51)
**Authors:** Stefan F. Schouten, Peter Bloem

52. [Mutual Information guided Visual Contrastive Learning](#user-content-link52)
**Authors:** Hanyang Chen, Yanchao Yang

53. [The Sequential Edge: Inverse-Entropy Voting Beats Parallel Self-Consistency at Matched Compute](#user-content-link53)
**Authors:** Aman Sharma, Paras Chopra

54. [SKGE: Spherical Knowledge Graph Embedding with Geometric Regularization](#user-content-link54)
**Authors:** Xuan-Truong Quan, Xuan-Son Quan, Duc Do Minh, Vinh Nguyen Van

---

## 1. [From Models to Operators: Rethinking Autoscaling Granularity for Large Generative Models](https://arxiv.org/abs/2511.02248) <a id="link1"></a>
...
**Comment:** Operator-level autoscaling with profiling-informed scaling/batching/placement for generative model serving — strong ML Systems contribution.
...
## 2. [FP8-Flow-MoE: A Casting-Free FP8 Recipe without Double Quantization Error](https://arxiv.org/abs/2511.02302) <a id="link2"></a>
...
**Comment:** High Performance Computing + Efficiency: FP8-centric, quantization-consistent dataflow with scaling-aware transpose and fused operators for MoE training; eliminates redundant Q/DQ casts.
...
## 3. [Eliminating Multi-GPU Performance Taxes: A Systems Approach to Efficient Distributed LLMs](https://arxiv.org/abs/2511.02168) <a id="link3"></a>
...
**Comment:** Strongly matches High-Performance Computing and ML Systems with new in-kernel communication patterns (beyond BSP) that address synchronization, data locality, and launch overhead for distributed LLM workloads.
...
## 4. [LongCat-Flash-Omni Technical Report](https://arxiv.org/abs/2511.00279) <a id="link4"></a>
...
**Comment:** Strong match to Model Architecture (MoE) and ML Systems (distributed multimodal training) criteria: shortcut-connected MoE with zero-compute experts and modality-decoupled parallelism for large-scale omni-modal training.
...
## 5. [Optimizing Attention on GPUs by Exploiting GPU Architectural NUMA Effects](https://arxiv.org/abs/2511.02132) <a id="link5"></a>
...
**Comment:** Matches ML Systems/HPC: NUMA-aware attention kernel scheduling (Swizzled Head-first Mapping) on multi-chiplet GPUs, improving cache locality and performance with quantitative analysis on MI300X.
...
## 6. [MISA: Memory-Efficient LLMs Optimization with Module-wise Importance Sampling](https://arxiv.org/abs/2511.00056) <a id="link6"></a>
...
**Comment:** Matches ML Systems/Efficiency: module-wise importance sampling for memory-efficient LLM optimization with variance reduction guarantees, O(1/sqrt(K)) convergence, and detailed memory analysis (code released).
...
## 7. [Linear Differential Vision Transformer: Learning Visual Contrasts via Pairwise Differentials](https://arxiv.org/abs/2511.00833) <a id="link7"></a>
...
**Comment:** Visual-Contrast Attention replaces MHSA with lower-complexity O(N·n·C) interaction — matches Model Architecture and Efficiency criteria.
...
## 8. [Opportunistic Expert Activation: Batch-Aware Expert Routing for Faster Decode Without Retraining](https://arxiv.org/abs/2511.02237) <a id="link8"></a>
...
**Comment:** Directly matches Model Architecture (MoE) and Efficiency/ML Systems: batch-aware expert routing to reduce activated experts and decode latency without retraining; algorithm–system co-design for memory-bound MoE inference.
...
## 9. [Flashlight: PyTorch Compiler Extensions to Accelerate Attention Variants](https://arxiv.org/abs/2511.02043) <a id="link9"></a>
...
**Comment:** Strongly matches ML-Systems/compiler criterion: compiler-native fusion/tiling to auto-generate FlashAttention-style kernels for arbitrary attention programs, enabling operator fusion and high performance.
...
## 10. [Language Modeling With Factorization Memory](https://arxiv.org/abs/2511.00315) <a id="link10"></a>
...
**Comment:** Model Architecture and Efficiency: proposes a new RNN (Factorization Memory) with sparse memory activation, parallelizable training, and constant-complexity inference for long contexts.
...
## 11. [ExplicitLM: Decoupling Knowledge from Parameters via Explicit Memory Banks](https://arxiv.org/abs/2511.01581) <a id="link11"></a>
...
**Comment:** Model Architecture: introduces an external million-scale explicit memory with differentiable two-stage retrieval (product-key coarse filtering + Gumbel-Softmax matching) to decouple knowledge from parameters for interpretable, updatable LMs.
...
## 12. [Scalable Processing-Near-Memory for 1M-Token LLM Inference: CXL-Enabled KV-Cache Management Beyond GPU Limits](https://arxiv.org/abs/2511.00321) <a id="link12"></a>
...
**Comment:** ML Systems: CXL-enabled processing-near-memory KV-cache management for long-context LLM inference, offloading token-page selection to PNM with hybrid parallelism—clear memory/IO management and hardware–software co-design with strong empirical gains.
...
## 13. [Calibrating and Rotating: A Unified Framework for Weight Conditioning in PEFT](https://arxiv.org/abs/2511.00051) <a id="link13"></a>
...
**Comment:** Strong match to Model Architecture and Compression/Efficiency: reformulates DoRA, analyzes singular value entropy, and proposes parameter-efficient conditioning (Pre-Diag, SORA) for PEFT.
...
## 14. [CudaForge: An Agent Framework with Hardware Feedback for CUDA Kernel Optimization](https://arxiv.org/abs/2511.01884) <a id="link14"></a>
...
**Comment:** Strongly matches ML Systems (compiler/kernels and hardware–software co-design) by integrating hardware feedback (NCU metrics) in a multi-agent, training-free CUDA kernel optimization workflow.
...
## 15. [Scaling Graph Chain-of-Thought Reasoning: A Multi-Agent Framework with Efficient LLM Serving](https://arxiv.org/abs/2511.01633) <a id="link15"></a>
...
**Comment:** LLM inference-serving innovations (graph-aware KV-cache management, priority eviction, pipelined execution) co-designed with multi-agent reasoning — strong ML Systems match.
...
## 16. [Belief Dynamics Reveal the Dual Nature of In-Context Learning and Activation Steering](https://arxiv.org/abs/2511.00617) <a id="link16"></a>
...
**Comment:** Unified Bayesian model of in-context learning and activation steering with predictive validity — matches Representation Learning/training dynamics criterion.
...
## 17. [Federated Attention: A Distributed Paradigm for Collaborative LLM Inference over Edge Networks](https://arxiv.org/abs/2511.02647) <a id="link17"></a>
...
**Comment:** Matches ML Systems: proposes a distributed inference protocol integrating federated-style KV aggregation into attention with theoretical analysis of communication/quality trade-offs and efficiency via sparse attention—generalizable, system–algorithm co-design.
...
## 18. [A Proof of Learning Rate Transfer under $\mu$P](https://arxiv.org/abs/2511.01734) <a id="link18"></a>
...
**Comment:** Matches Representation Learning/training theory: first proof of learning rate transfer under μP parameterization; foundational insight into scaling laws and training dynamics.
...
## 19. [The Hidden Power of Normalization: Exponential Capacity Control in Deep Neural Networks](https://arxiv.org/abs/2511.00958) <a id="link19"></a>
...
**Comment:** Matches Representation Learning/theory: provides principled capacity control explanation for normalization with exponential Lipschitz reduction, linking to optimization stability and generalization.
...
## 20. [How Focused Are LLMs? A Quantitative Study via Repetitive Deterministic Prediction Tasks](https://arxiv.org/abs/2511.00763) <a id="link20"></a>
...
**Comment:** Representation Learning: quantitative analysis of deterministic sequence accuracy and an interpretable statistical model linking attention interference to failure rates.
...
## 21. [From Uniform to Adaptive: General Skip-Block Mechanisms for Efficient PDE Neural Operators](https://arxiv.org/abs/2511.00032) <a id="link21"></a>
...
**Comment:** Model Architecture and Efficiency: introduces conditional/dynamic token routing (Skip-Block Routing) in Transformer-based neural operators to cut FLOPs and adapt compute per token.
...
## 22. [Isotropic Curvature Model for Understanding Deep Learning Optimization: Is Gradient Orthogonalization Optimal?](https://arxiv.org/abs/2511.00674) <a id="link22"></a>
...
**Comment:** Representation Learning and training dynamics theory: isotropic curvature model analyzing optimizer behavior (e.g., gradient orthogonalization) with implications for new optimization methods.
...
## 23. [On the Emergence of Induction Heads for In-Context Learning](https://arxiv.org/abs/2511.01033) <a id="link23"></a>
...
**Comment:** Representation Learning/Training Dynamics: theoretic–empirical analysis of induction head emergence in transformers with low-dimensional training subspace and timing bounds.
...
## 24. [Matrix Sensing with Kernel Optimal Loss: Robustness and Optimization Landscape](https://arxiv.org/abs/2511.02122) <a id="link24"></a>
...
**Comment:** Matches Optimization/Representation Learning theory: robust kernel-optimal loss for matrix sensing with analysis of optimization landscape and RIP conditions.
...
## 25. [The stability of shallow neural networks on spheres: A sharp spectral analysis](https://arxiv.org/abs/2511.02625) <a id="link25"></a>
...
**Comment:** Matches model analysis/representation learning criterion: sharp spectral analysis of shallow ReLU^k networks on spheres linking eigenstructure to approximation power and numerical stability (conditioning of mass/stiffness matrices).
...
## 26. [Optimal Singular Damage: Efficient LLM Inference in Low Storage Regimes](https://arxiv.org/abs/2511.02681) <a id="link26"></a>
...
**Comment:** Strongly matches Model Compression/Efficiency by jointly exploiting low-rank and sparsity for storing fine-tune deltas with selective sparsified low-rank updates.
...
## 27. [When, What, and How: Rethinking Retrieval-Enhanced Speculative Decoding](https://arxiv.org/abs/2511.01282) <a id="link27"></a>
...
**Comment:** Strongly matches Efficiency/Inference Systems via retrieval-enhanced speculative decoding with adaptive triggering, feedback-driven candidate selection, and relaxed verification.
...
## 28. [Apriel-H1: Towards Efficient Enterprise Reasoning Models](https://arxiv.org/abs/2511.02651) <a id="link28"></a>
...
**Comment:** Matches Model Architecture/Efficiency: hybrid SSM–Transformer via distillation, systematically replacing attention with Mamba to boost inference throughput (2x in vLLM) with analysis across SSM-to-MHA ratios.
...
## 29. [Dynamic Routing Between Experts: A Data-Efficient Approach to Continual Learning in Vision-Language Models](https://arxiv.org/abs/2511.01831) <a id="link29"></a>
...
**Comment:** Model Architecture: dynamic routing between experts (MoE-style) for continual learning in VLMs, a conditional network design rather than task-specific fine-tuning.
...
## 30. [Loquetier: A Virtualized Multi-LoRA Framework for Unified LLM Fine-tuning and Serving](https://arxiv.org/abs/2511.00101) <a id="link30"></a>
...
**Comment:** Matches ML-Systems inference-serving criterion: unified runtime for multi-LoRA fine-tuning and serving with virtualized adapters and fused forward kernels, improving throughput/SLOs.
...
## 31. [Efficiently Training A Flat Neural Network Before It has been Quantizated](https://arxiv.org/abs/2511.01462) <a id="link31"></a>
...
**Comment:** Model Compression and Efficiency: pre-conditions networks for low-bit PTQ by modeling activation/weight quantization errors as Gaussian noise and optimizing for flat minima.
...
## 32. [Regularization Through Reasoning: Systematic Improvements in Language Model Classification via Explanation-Enhanced Fine-Tuning](https://arxiv.org/abs/2511.02044) <a id="link32"></a>
...
**Comment:** Representation Learning: explanation-augmented fine-tuning acts as a computation-regularizer; provides insights into internal activation entropy and decision dynamics.
...
## 33. [Real-time Continual Learning on Intel Loihi 2](https://arxiv.org/abs/2511.01553) <a id="link33"></a>
...
**Comment:** ML Systems and hardware–software co-design: event-driven, sparse SNN continual-learning algorithm on Loihi 2 with strong energy/latency measurements for edge deployment.
...
## 34. [Bulk-boundary decomposition of neural networks](https://arxiv.org/abs/2511.02003) <a id="link34"></a>
...
**Comment:** Representation Learning / Training Dynamics: proposes a bulk–boundary decomposition of SGD dynamics and a field-theoretic formulation, offering fundamental insights into how architecture and data drive learning.
...
## 35. [Redundancy Maximization as a Principle of Associative Memory Learning](https://arxiv.org/abs/2511.02584) <a id="link35"></a>
...
**Comment:** Representation Learning/Architecture: proposes redundancy maximization via PID as a local learning objective for associative memory with large capacity gains.
...
## 36. [Efficient Vector Symbolic Architectures from Histogram Recovery](https://arxiv.org/abs/2511.01838) <a id="link36"></a>
...
**Comment:** Representation Learning: coding-theoretic VSA using Reed–Solomon + Hadamard with optimal histogram recovery, providing formal guarantees for composition and recovery.
...
## 37. [Multi-Step Knowledge Interaction Analysis via Rank-2 Subspace Disentanglement](https://arxiv.org/abs/2511.01706) <a id="link37"></a>
...
**Comment:** Matches Representation Learning criterion by proposing a rank-2 subspace disentanglement to analyze PK–CK interactions over multi-step generations, with code/benchmarks.
...
## 38. [In Good GRACEs: Principled Teacher Selection for Knowledge Distillation](https://arxiv.org/abs/2511.02833) <a id="link38"></a>
...
**Comment:** Matches Representation Learning/Training and Compression/Efficiency via a principled teacher-selection metric (GRACE) for distillation with stability-based justification.
...
## 39. [Learning with Category-Equivariant Architectures for Human Activity Recognition](https://arxiv.org/abs/2511.01139) <a id="link39"></a>
...
**Comment:** Matches Model Architecture (equivariance) by introducing a category-equivariant network encoding temporal, gain, and sensor-hierarchy symmetries.
...
## 40. [Adam Reduces a Unique Form of Sharpness: Theoretical Insights Near the Minimizer Manifold](https://arxiv.org/abs/2511.02773) <a id="link40"></a>
...
**Comment:** Matches Representation Learning (training dynamics) criterion by providing theoretical insights into how adaptive optimizers like Adam implicitly minimize a distinct sharpness measure, with implications for sparsity and generalization.
...
## 41. [A Non-Adversarial Approach to Idempotent Generative Modelling](https://arxiv.org/abs/2511.02614) <a id="link41"></a>
...
**Comment:** Matches Model Architecture and Representation Learning criteria: proposes a non-adversarial idempotent generative model acting as a manifold projector with IMLE-based training.
...
## 42. [Forget BIT, It is All about TOKEN: Towards Semantic Information Theory for LLMs](https://arxiv.org/abs/2511.01202) <a id="link42"></a>
...
**Comment:** Matches Representation Learning/theory criterion: semantic information-theoretic framework for LLMs with structure-agnostic measures and theoretical links to Transformer performance.
...
## 43. [Energy-Efficient Deep Learning Without Backpropagation: A Rigorous Evaluation of Forward-Only Algorithms](https://arxiv.org/abs/2511.01061) <a id="link43"></a>
...
**Comment:** Matches Model Architecture and Efficiency: proposes a forward-only training algorithm (Mono-Forward) as an alternative to backprop with hardware-validated energy/time savings and a critical memory-efficiency analysis.
...
## 44. [Re-FORC: Adaptive Reward Prediction for Efficient Chain-of-Thought Reasoning](https://arxiv.org/abs/2511.02130) <a id="link44"></a>
...
**Comment:** Algorithmic test-time compute allocation (early stopping, adaptive reasoning length/model selection) for LLMs — matches Compression/Efficiency criterion.
...
## 45. [Shared Parameter Subspaces and Cross-Task Linearity in Emergently Misaligned Behavior](https://arxiv.org/abs/2511.02022) <a id="link45"></a>
...
**Comment:** Parameter-space/representation analysis revealing shared low-dimensional subspaces and linear mode connectivity — matches Representation Learning/training dynamics criterion.
...
## 46. [Generalizing Test-time Compute-optimal Scaling as an Optimizable Graph](https://arxiv.org/abs/2511.00086) <a id="link46"></a>
...
**Comment:** Formulates test-time scaling as a probabilistic collaboration graph and searches compute-optimal multi-LLM architectures — matches Efficiency and ML Systems criteria.
...
## 47. [Neural network initialization with nonlinear characteristics and information on spectral bias](https://arxiv.org/abs/2511.02244) <a id="link47"></a>
...
**Comment:** Representation Learning: spectral-bias–aware initialization (scaled SWIM) to improve learning dynamics; focuses on intrinsic frequency properties of networks.
...
## 48. [RoME: Domain-Robust Mixture-of-Experts for MILP Solution Prediction across Domains](https://arxiv.org/abs/2511.02331) <a id="link48"></a>
...
**Comment:** Model Architecture: domain-robust Mixture-of-Experts with dynamic routing and DRO training to generalize across MILP domains.
...
## 49. [Energy Loss Functions for Physical Systems](https://arxiv.org/abs/2511.02087) <a id="link49"></a>
...
**Comment:** Matches Representation Learning criterion: introduces physically grounded, architecture-agnostic energy-based loss functions derived via reverse KL to Boltzmann distributions, respecting symmetries.
...
## 50. [ConMeZO: Adaptive Descent-Direction Sampling for Gradient-Free Finetuning of Large Language Models](https://arxiv.org/abs/2511.02757) <a id="link50"></a>
...
**Comment:** Model Compression and Efficiency: zeroth-order finetuning that avoids backprop memory, with an algorithmic innovation—cone-constrained adaptive directional sampling with convergence guarantees—to accelerate gradient-free training of LLMs.
...
## 51. [LLM Probing with Contrastive Eigenproblems: Improving Understanding and Applicability of CCS](https://arxiv.org/abs/2511.02089) <a id="link51"></a>
...
**Comment:** Representation Learning: reformulates CCS probing as a contrastive eigenproblem with closed-form solutions, enhancing mechanistic interpretability without training.
...
## 52. [Mutual Information guided Visual Contrastive Learning](https://arxiv.org/abs/2511.00028) <a id="link52"></a>
...
**Comment:** Matches Representation Learning: MI-guided positive sample selection for contrastive learning, improving invariance beyond hand-crafted augmentations.
...
## 53. [The Sequential Edge: Inverse-Entropy Voting Beats Parallel Self-Consistency at Matched Compute](https://arxiv.org/abs/2511.02309) <a id="link53"></a>
...
**Comment:** Matches ML Systems (inference-time optimization): proposes sequential test-time scaling with inverse-entropy voting, showing generalizable gains at matched compute.
...
## 54. [SKGE: Spherical Knowledge Graph Embedding with Geometric Regularization](https://arxiv.org/abs/2511.02460) <a id="link54"></a>
...
**Comment:** Matches Representation Learning criterion: introduces a spherical manifold prior via a learnable spherization layer and translate–then–project relations with theoretical analysis (inherently hard negative sampling) and broad KGE gains.
