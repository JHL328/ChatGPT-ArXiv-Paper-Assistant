...
1. [The Communication Bottleneck: A Round-Trip Study of Tree-Structured Expression Serialization in Language Models](#user-content-link1)
**Authors:** Xavier Suau, Alex Ferrando de las Morenas, Luca Zappella, Samy Bengio

---

## 1. [The Communication Bottleneck: A Round-Trip Study of Tree-Structured Expression Serialization in Language Models](https://arxiv.org/abs/2609.21509) <a id="link1"></a>
